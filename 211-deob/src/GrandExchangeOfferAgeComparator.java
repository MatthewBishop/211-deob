    ...
    static void drawTitle(Font var0, Font var1, Font var2) {
        ...
        if (Login.worldSelectOpen) {
            ...
            if (Client.gameState == 20) {
                class147.titleboxSprite.drawAt(Login.loginBoxX + 180 - class147.titleboxSprite.subWidth / 2,
                        271 - class147.titleboxSprite.subHeight / 2);
                var25 = 201;
                ...
                if (Login.loginIndex != 4 && Login.loginIndex != 10) {
                    ...
                    for (var5 = FriendLoginUpdate.method2081(); var0.stringWidth(var5) > var27; var5 = var5.substring(0,
                            var5.length() - 1)) {
                        ;
                    }
            ...
            if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
                ...
                if (Login.loginIndex == 0) {
                    ...
                    if (Login.loginIndex == 2) {
                        ...
                        for (var5 = FriendLoginUpdate.method2081(); var0.stringWidth(var5) > var27; var5 = var5
                                .substring(1)) {
                            ;
                        }
                        ...
                        var0.draw(AbstractFont.escapeBrackets(var5)
                                + (Login.currentLoginField == 0 & Client.cycle % 40 < 20
                                        ? class149.colorStartTag(16776960) + "|"
                                        : ""),
                                class143.loginBoxCenter - 70, var26, 16777215, 0);
                        var26 += 15;
                        var7 = Login.Login_password;
                        var6 = KeyHandler.method94('*', var7.length());
                        ...
                        var0.draw("Password: " + var8
                                + (Login.currentLoginField == 1 & Client.cycle % 40 < 20
                                        ? class149.colorStartTag(16776960) + "|"
                                        : ""),
                                class143.loginBoxCenter - 108, var26, 16777215, 0);
                        var26 += 15;
                        var25 = 277;
                        var9 = class143.loginBoxCenter + -117;
                        boolean var11 = Client.Login_isUsernameRemembered;
                        boolean var12 = Login.field772;
                        var10 = var11 ? (var12 ? class100.field1079 : Login.options_buttons_2Sprite)
                                : (var12 ? ChatChannel.field828 : Login.options_buttons_0Sprite);
                        ...
                        IndexedSprite var14 = var15 ? (var16 ? class100.field1079 : Login.options_buttons_2Sprite)
                                : (var16 ? ChatChannel.field828 : Login.options_buttons_0Sprite);
                        ...
                        Calendar.field3019 = new Bounds(class143.loginBoxCenter, var25,
                                var1.stringWidth(BoundaryObject.field2196), 11);
                        class290.field2708 = new Bounds(class143.loginBoxCenter, var25,
                        ...
                        var6 = KeyHandler.method94('*', var7.length());
                        var0.draw(var5 + var6 + (Client.cycle % 40 < 20 ? class149.colorStartTag(16776960) + "|" : ""),
                                Login.loginBoxX + 180 - 108, var26, 16777215, 0);
                        var26 -= 8;
                        ...
                        var0.draw(
                                AbstractFont.escapeBrackets(var5)
                                        + (Client.cycle % 40 < 20 ? class149.colorStartTag(16776960) + "|" : ""),
                                Login.loginBoxX + 180 - 34, var26, 16777215, 0);
                        var26 += 15;
                        ...
                        var23 = 356;
                        var1.drawCentered("Still having trouble logging in?", class143.loginBoxCenter, var23, 268435455,
                                0);
                        ...
                        if (class209.field1857 && !Client.onMobile) {
                            ...
                            for (var30 = 0; var30 < 8; ++var30) {
                                ...
                                var0.draw(
                                        (Login.field761[var30] == null ? "" : Login.field761[var30])
                                                + (var32 ? class149.colorStartTag(16776960) + "|" : ""),
                                        var4 + 10, var26 + 27, 16777215, 0);
                                if (var30 != 1 && var30 != 3) {
                                    var4 += 35;
                                } else {
                                    var4 += 50;
                            ...
                            var25 = 216;
                            var0.drawCentered("Your date of birth isn't set.", Login.loginBoxX + 180, var25, 16776960,
                                    0);
                            var26 = var25 + 15;
                            var2.drawCentered("Please verify your account status by", Login.loginBoxX + 180, var26,
                                    16776960, 0);
                            var26 += 15;
                        ...
                        var0.drawCentered("Sorry, but your account is not eligible to play.", Login.loginBoxX + 180,
                                var25, 16776960, 0);
                        var26 = var25 + 15;
                        var2.drawCentered("For more information, please take a look at", Login.loginBoxX + 180, var26,
                                16776960, 0);
                        var26 += 15;
                        ...
                        var27 = 216;
                        var2.drawCentered("Before using this app, please read and accept our", var26, var27, 16777215,
                                0);
                        var4 = var27 + 17;
                        var2.drawCentered(
                                "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
                                var26, var4, 16777215, 0);
                        var4 += 17;
                        ...
                        var2.drawCentered("You must accept our terms of use, privacy policy,", Login.loginBoxX + 180,
                                var25, 16777215, 0);
                        var26 = var25 + 20;
                        var2.drawCentered("and end user licence agreement to continue.", Login.loginBoxX + 180, var26,
                                16777215, 0);
                        var4 = Login.loginBoxX + 180;
                        var25 = 311;
            ...
            Login.title_muteSprite[PacketWriter.clientPreferences.getTitleMusicDisabled() ? 1 : 0]
            ...
            if (Client.gameState > 5 && class36.clientLanguage == Language.Language_EN) {
                if (Login.field769 != null) {
                    ...
                    var0.drawCentered("World" + " " + Client.worldId, var35 / 2 + var26, var34 / 2 + var27 - 2,
                            16777215, 0);
