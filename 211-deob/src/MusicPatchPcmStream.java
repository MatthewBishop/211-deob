public class MusicPatchPcmStream extends PcmStream {
        ...
        if ((this.superStream.field2719[var1.field2771] & 4) != 0 && var1.field2775 < 0) {
            ...
            while (true) {
                ...
                if (this.superStream.field2728[var1.field2771] == 0) {
                    var1.stream = RawPcmStream.method257(var1.rawSound, var10.method272(), var10.method239(),
                            var10.method267());
                } else {
    ...
    void method1613(MusicPatchNode var1, int var2) {
        if ((this.superStream.field2719[var1.field2771] & 4) != 0 && var1.field2775 < 0) {
            ...
            if (var4 <= var2) {
                if (this.superStream.field2728[var1.field2771] == 0) {
                    var1.stream = RawPcmStream.method257(var1.rawSound, var1.stream.method272(),
                            var1.stream.method239(), var1.stream.method267());
                } else {
                    var1.stream = RawPcmStream.method257(var1.rawSound, var1.stream.method272(), 0,
                            var1.stream.method267());
                    this.superStream.method1584(var1, var1.patch.field2755[var1.field2766] < 0);
                }
