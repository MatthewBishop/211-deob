public final class class366 {
    ...
    public static final char[] base37Table = new char[] { '_', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k',
            ...
            if (Client.titleLoadingStage == 45) {
                ...
                if (Client.titleLoadingStage == 60) {
                    ...
                    if (!class372.archive2.isFullyLoaded()) {
                        ...
                        KitDefinition.KitDefinition_fileCount = KitDefinition.KitDefinition_archive
                                .getGroupFileCount(3);
                        ...
                        WorldMapLabel.Widget_interfaceComponents = new Widget[UserComparator8.Widget_archive
                                .getGroupCount()][];
                        ...
                        class491.HitSplatDefinition_cachedSprites = new class458(class134.field1270, 54,
                                class36.clientLanguage, class372.archive2);
                        MoveSpeed.HitSplatDefinition_cached = new class458(class134.field1270, 47,
                                class36.clientLanguage, class372.archive2);
                    ...
                    if (SoundSystem.compass == null) {
                        SoundSystem.compass = BZip2State.SpriteBuffer_getSprite(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.compass, 0);
                    } else {
                        ++var0;
                    }

                    if (PacketBufferNode.redHintArrowSprite == null) {
                        PacketBufferNode.redHintArrowSprite = BZip2State.SpriteBuffer_getSprite(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.field3758, 0);
                    } else {
                        ++var0;
                    }
                    ...
                    if (ClanChannel.headIconPkSprites == null) {
                        ClanChannel.headIconPkSprites = AABB.method1240(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.headIconsPk, 0);
                    } else {
                        ++var0;
                    }

                    if (class367.headIconPrayerSprites == null) {
                        class367.headIconPrayerSprites = AABB.method1240(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.field3753, 0);
                    } else {
                        ++var0;
                    }

                    if (WorldMapSectionType.headIconHintSprites == null) {
                        WorldMapSectionType.headIconHintSprites = AABB.method1240(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.field3754, 0);
                    } else {
                        ++var0;
                    }

                    if (UserComparator6.mapMarkerSprites == null) {
                        UserComparator6.mapMarkerSprites = AABB.method1240(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.field3757, 0);
                    } else {
                        ++var0;
                    }

                    if (Calendar.crossSprites == null) {
                        Calendar.crossSprites = AABB.method1240(WorldMapEvent.archive8, ScriptFrame.spriteIds.field3756,
                                0);
                    } else {
                        ++var0;
                    }
                    ...
                    if (UrlRequest.mapDotSprites == null) {
                        UrlRequest.mapDotSprites = AABB.method1240(WorldMapEvent.archive8,
                                ScriptFrame.spriteIds.field3759, 0);
                    } else {
                        ++var0;
                    }
                    ...
                    if (!class148.field1333.isFullyLoaded()) {
                        ...
                        GameBuild.textureProvider = new TextureProvider(class148.field1333, WorldMapEvent.archive8, 20,
                                PacketWriter.clientPreferences.getBrightness(), Client.isLowDetail ? 64 : 128);
                    ...
                    if (!class144.archive4.isFullyLoaded()) {
                        ...
                        Login.Login_loadingText = "Loading interfaces - "
                                + (96 + PendingSpawn.archive13.loadPercent() / 50) + "%";
                        Login.Login_loadingPercent = 96;
                    } else {
                    ...
                    if (!GameEngine.archive19.tryLoadGroupByName(WorldMapCacheName.field2395.name)) {
                        Login.Login_loadingText = "Loading world map - "
                                + GameEngine.archive19.groupLoadPercentByName(WorldMapCacheName.field2395.name) / 10
                                + "%";
                    } else {
                        if (GrandExchangeOfferUnitPriceComparator.worldMap == null) {
                            GrandExchangeOfferUnitPriceComparator.worldMap = new WorldMap();
                            GrandExchangeOfferUnitPriceComparator.worldMap.init(GameEngine.archive19,
                                    class419.archive18, class27.archive20, class19.fontBold12, Client.fontsMap,
                                    VarpDefinition.mapSceneSprites);
                        }
