public class class103 {
    ...
    static final void Widget_addToMenu(Widget var0, int var1, int var2) {
        ...
        if (var0.buttonType == 2 && !Client.isSpellSelected) {
            ...
            if (var3 != null) {
                class285.method1545(var3, class149.colorStartTag(65280) + var0.spellName, 25, 0, -1, var0.id,
                        var0.itemId);
            }
        }
                        ...
                        if (var0.itemIds[var17] > 0) {
                            label318: {
                                ...
                                if (Client.isItemSelected == 1) {
                                    ...
                                    var9 = (var10 >> 30 & 1) != 0;
                                    if (var9) {
                                        if (var0.id != WorldMapLabel.selectedItemWidget
                                                || var17 != WorldMapIcon_0.selectedItemSlot) {
                                            class285.method1545("Use",
                                                    Client.selectedItemName + " " + "->" + " "
                                                            + class149.colorStartTag(16748608) + var8.name,
                                                    31, 0, var17, var0.id, var8.id);
                                        }
                                        break label318;
                                    }
                                }
                                ...
                                if (Client.isSpellSelected) {
                                    ...
                                    if (var9) {
                                        if ((class149.selectedSpellFlags & 16) == 16) {
                                            class285.method1545(Client.selectedSpellActionName,
                                                    Client.selectedSpellName + " " + "->" + " "
                                                            + class149.colorStartTag(16748608) + var8.name,
                                                    32, 0, var17, var0.id, var8.id);
                                        }
                                        break label318;
                                    }
                                }
                                ...
                                if (class288.method1551(class173.getWidgetFlags(var0))) {
                                    class285.method1545("Use", class149.colorStartTag(16748608) + var8.name, 38, 0,
                                            var17, var0.id, var8.id);
                                }
                                ...
                                if (var18 != null) {
                                    for (var15 = 4; var15 >= 0; --var15) {
                                        if (var18[var15] != null) {
                                            ...
                                            class285.method1545(var18[var15],
                                                    class149.colorStartTag(16748608) + var8.name, var16, 0, var17,
                                                    var0.id, var8.id);
                                        }
                                    }
                                }

                                class285.method1545("Examine", class149.colorStartTag(16748608) + var8.name, 1005, 0,
                                        var17, var0.id, var8.id);
                            }
                        }
                    }
            ...
            if (Client.isSpellSelected) {
                ...
                for (var17 = 9; var17 >= 5; --var17) {
                    ...
                    if (!ItemLayer.method1115(class173.getWidgetFlags(var0), var17) && var0.onOp == null) {
                        var19 = null;
                    } else if (var0.actions != null && var0.actions.length > var17 && var0.actions[var17] != null
                            && var0.actions[var17].trim().length() != 0) {
                    ...
                    if (var19 != null) {
                        class285.method1545(var19, var0.dataText, 1007, var17 + 1, var0.childIndex, var0.id,
                                var0.itemId);
                    }
                }
                ...
                for (var4 = 4; var4 >= 0; --var4) {
                    ...
                    if (var20 != null) {
                        class290.insertMenuItem(var20, var0.dataText, 57, var4 + 1, var0.childIndex, var0.id,
