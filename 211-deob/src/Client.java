...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
        ...
        for (int var5 = 0; var5 < var3 + 0; var5 += 3) {
            ...
            if (var5 < var3 - 1) {
                ...
                if (var5 < var3 - 2) {
                    ...
                    var4.append(class363.field3571[(var7 & 15) << 2 | var8 >>> 6])
                            .append(class363.field3571[var8 & 63]);
                } else {
    ...
    protected final void setUp() {
        ...
        class12.masterDisk = new ArchiveDisk(255, JagexCache.JagexCache_dat2File, JagexCache.JagexCache_idx255File,
                500000);
    ...
    protected final void draw(boolean var1) {
            ...
            try {
                if (class290.musicPlayerStatus == 2) {
                    if (class427.musicTrack == null) {
                        class427.musicTrack = MusicTrack.readTrack(class6.musicTrackArchive, class20.musicTrackGroupId,
                                class161.musicTrackFileId);
                        if (class427.musicTrack == null) {
                            var2 = false;
                            break label170;
                        }
                    ...
                    if (class154.soundCache == null) {
                        class154.soundCache = new SoundCache(class290.soundEffectsArchive,
                                class290.musicSamplesArchive);
                    }

                    if (class290.midiPcmStream.loadMusicTrack(class427.musicTrack, class290.musicPatchesArchive,
                            class154.soundCache, 22050)) {
        ...
        if ((gameState == 10 || gameState == 20 || gameState == 30) && field599 != 0L
                && class153.clockNow() > field599) {
        ...
        if (gameState == 0) {
            ...
            if (gameState == 20) {
                GrandExchangeOfferAgeComparator.drawTitle(class19.fontBold12, class276.fontPlain11,
                        MenuAction.fontPlain12);
            } else if (gameState == 50) {
                GrandExchangeOfferAgeComparator.drawTitle(class19.fontBold12, class276.fontPlain11,
                        MenuAction.fontPlain12);
            } else if (gameState == 25) {
                ...
                class165.drawLoadingMessage("Connection lost" + "<br>" + "Please wait - attempting to reestablish",
                        false);
        ...
        if (gameState == 30 && gameDrawingMode == 0 && !var1 && !isResizable) {
            for (var4 = 0; var4 < rootWidgetCount; ++var4) {
                if (field546[var4]) {
                    KeyHandler.rasterProvider.draw(rootWidgetXs[var4], rootWidgetYs[var4], rootWidgetWidths[var4],
                            rootWidgetHeights[var4]);
                    field546[var4] = false;
                }
            }
        } else if (gameState > 0) {
    ...
    boolean method369() {
        return Frames.field2059 != null && !Frames.field2059.trim().isEmpty() && class152.field1373 != null
                && !class152.field1373.trim().isEmpty();
    }

    boolean method343() {
        return MusicPatchNode.field2783 != null && !MusicPatchNode.field2783.trim().isEmpty()
                && VarcInt.field1501 != null && !VarcInt.field1501.trim().isEmpty();
    }
            ...
            if (--js5Cycles + 1 <= 0) {
                try {
                    if (js5ConnectState == 0) {
                        WorldMapManager.js5SocketTask = GameEngine.taskHandler.newSocketTask(NetCache.worldHost,
                                Calendar.currentPort);
                        ++js5ConnectState;
                    }
        ...
        try {
            if (loginState == 0) {
                if (GrandExchangeOfferTotalQuantityComparator.secureRandom == null
                        && (secureRandomFuture.isDone() || field400 > 250)) {
            ...
            if (loginState == 20) {
                if (this.field409 != null) {
                    ...
                    if (var25.method76() != 200) {
                        class121.RunException_sendStackTrace(
                                "Response code: " + var25.method76() + "Response body: " + var25.method75(),
                                (Throwable) null);
                        class33.getLoginError(65);
                        this.field548 = null;
                        return;
            ...
            if (loginState == 1) {
                if (BufferedSource.socketTask == null) {
                    BufferedSource.socketTask = GameEngine.taskHandler.newSocketTask(NetCache.worldHost,
                            Calendar.currentPort);
                }
            ...
            if (loginState == 5) {
                ...
                int[] var32 = new int[] { GrandExchangeOfferTotalQuantityComparator.secureRandom.nextInt(),
                        GrandExchangeOfferTotalQuantityComparator.secureRandom.nextInt(),
                        GrandExchangeOfferTotalQuantityComparator.secureRandom.nextInt(),
                        GrandExchangeOfferTotalQuantityComparator.secureRandom.nextInt() };
                var31.offset = 0;
                var31.writeByte(1);
            ...
            if (loginState == 13) {
                field400 = 0;
                class70.setLoginResponseString("You have only just left another world.",
                        "Your profile will be transferred in:", field514 / 60 + " seconds.");
                if (--field514 <= 0) {
                    ModeWhere.method1885(0);
                }
                ...
                if (loginState != 16) {
                    ...
                    if (((AbstractSocket) var1).available() >= packetWriter.serverPacketLength) {
                        ...
                        for (InterfaceParent var40 = (InterfaceParent) interfaceParents
                                .first(); var40 != null; var40 = (InterfaceParent) interfaceParents.next()) {
    ...
    final void doCycleLoggedIn() {
        ...
        if (hadNetworkError) {
            ...
            if (gameState == 30) {
                while (true) {
                    ReflectionCheck var2 = (ReflectionCheck) ReflectionCheck.reflectionChecks.last();
                    boolean var30;
                    if (var2 == null) {
                        var30 = false;
                    } else {
                    ...
                    if (!var30) {
                        ...
                        synchronized (class36.mouseRecorder.lock) {
                            if (!lockMouseRecorder) {
                                ...
                                for (var7 = 0; var7 < class36.mouseRecorder.index
                                        && (var31 == null || var31.packetBuffer.offset - var3 < 246); ++var7) {
                                    var4 = var7;
                                    ...
                                    if (var9 != lastMouseRecordX || var8 != lastMouseRecordY) {
                                        if (var31 == null) {
                                            var31 = Renderable.getPacketBufferNode(ClientPacket.field2534,
                                        ...
                                        if (-1L != lastMouseRecordTime) {
                                            ...
                                            var12 = (int) ((class36.mouseRecorder.millis[var7] - lastMouseRecordTime)
                                                    / 20L);
                                            var5 = (int) ((long) var5
                                                    + (class36.mouseRecorder.millis[var7] - lastMouseRecordTime) % 20L);
                                        } else {
                                            var10 = var9;
                                            var11 = var8;
                                ...
                                if (var4 >= class36.mouseRecorder.index) {
                                    ...
                                    System.arraycopy(class36.mouseRecorder.xs, var4, class36.mouseRecorder.xs, 0,
                                            class36.mouseRecorder.index);
                                    System.arraycopy(class36.mouseRecorder.ys, var4, class36.mouseRecorder.ys, 0,
                                            class36.mouseRecorder.index);
                                    System.arraycopy(class36.mouseRecorder.millis, var4, class36.mouseRecorder.millis,
                                            0, class36.mouseRecorder.index);
                                }
                            }
                        }
                        ...
                        if (MouseHandler.MouseHandler_lastButton == 1
                            ...
                            if (shouldProcessClick()) {
                                var18 = Renderable.getPacketBufferNode(ClientPacket.field2432,
                                        packetWriter.isaacCipher);
                                var18.packetBuffer
                                        .writeShort((var5 << 1) + (MouseHandler.MouseHandler_lastButton == 2 ? 1 : 0));
                        ...
                        for (PendingSpawn var40 = (PendingSpawn) pendingSpawns
                                .last(); var40 != null; var40 = (PendingSpawn) pendingSpawns.previous()) {
                            if (var40.endCycle > 0) {
                                --var40.endCycle;
                            }
                            ...
                            if (var40.endCycle == 0) {
                                ...
                                Skills.addPendingSpawnToScene(var40.plane, var40.type, var40.x, var40.y, var40.objectId,
                                        var40.field926, var40.field927);
                                var40.remove();
                            } else {
                                ...
                                if (var40.startCycle == 0 && var40.x >= 1 && var40.y >= 1 && var40.x <= 102
                                        && var40.y <= 102) {
                                    if (var40.id >= 0) {
                                        var3 = var40.id;
                                    ...
                                    Skills.addPendingSpawnToScene(var40.plane, var40.type, var40.x, var40.y, var40.id,
                                            var40.rotation, var40.objectType);
                                    var40.startCycle = -1;
                                    if (var40.objectId == var40.id && var40.objectId == -1) {
                                        var40.remove();
                                    } else if (var40.id == var40.objectId && var40.rotation == var40.field926
                                            && var40.field927 == var40.objectType) {
                                        var40.remove();
                                    }
                                }
                            }
                        ...
                        while (keyHandlerInstance.method1085() && field623 < 128) {
                            if (staffModLevel >= 2 && keyHandlerInstance.getKeyPressed(82)
                                    && keyHandlerInstance.field1832 == 66) {
                        ...
                        if (var34 && keyHandlerInstance.getKeyPressed(82) && keyHandlerInstance.getKeyPressed(81)
                                && mouseWheelRotation != 0) {
                            ...
                            if (var4 != class387.localPlayer.plane) {
                                class168.method891(class387.localPlayer.pathX[0] + ParamComposition.baseX,
                                        class387.localPlayer.pathY[0] + baseY, var4, false);
                            }
                        ...
                        if (rootInterface != -1) {
                            class144.updateRootInterface(rootInterface, 0, 0, GameEngine.canvasWidth,
                                    class127.canvasHeight, 0, 0);
                        }
                                        ...
                                        do {
                                            ...
                                            if (var25 == null) {
                                                while (true) {
                                                            ...
                                                            while (true) {
                                                                while (true) {
                                                                    ...
                                                                    do {
                                                                        do {
                                                                            do {
                                                                                var46 = (class204) field587
                                                                                        .removeLast();
                                                                                if (var46 == null) {
                                                                                    this.menu();
                                                                                    if (GrandExchangeOfferUnitPriceComparator.worldMap != null) {
                                                                                        GrandExchangeOfferUnitPriceComparator.worldMap
                                                                                                .method2290(
                                                                                                        class103.Client_plane,
                                                                                                        (class387.localPlayer.x >> 7)
                                                                                                                + ParamComposition.baseX,
                                                                                                        (class387.localPlayer.y >> 7)
                                                                                                                + baseY,
                                                                                                        false);
                                                                                        GrandExchangeOfferUnitPriceComparator.worldMap
                                                                                                .loadCache();
                                                                                    ...
                                                                                    if (WorldMapLabelSize.dragInventoryWidget != null) {
                                                                                        LoginScreenAnimation
                                                                                                .invalidateWidget(
                                                                                                        WorldMapLabelSize.dragInventoryWidget);
                                                                                        ++itemDragDuration;
                                                                                        if (MouseHandler.MouseHandler_currentButton == 0) {
                                                                                            if (field492) {
                                                                                                if (WorldMapLabelSize.dragInventoryWidget == class157.hoveredItemContainer
                                                                                                        && dragItemSlotSource != dragItemSlotDestination) {
                                                                                                    Widget var47 = WorldMapLabelSize.dragInventoryWidget;
                                                                                                    byte var35 = 0;
                                                                                                    if (field547 == 1
                                                                                                            && var47.contentType == 206) {
                                                                                                        var35 = 1;
                                                                                                    }
                                                                                                    ...
                                                                                                    var18.packetBuffer
                                                                                                            .method2382(
                                                                                                                    WorldMapLabelSize.dragInventoryWidget.id);
                                                                                                    packetWriter
                                                                                                            .addNode(
                                                                                                                    var18);
                                                                                                }
                                                                                            ...
                                                                                            WorldMapLabelSize.dragInventoryWidget = null;
                                                                                                ...
                                                                                                && (MouseHandler.MouseHandler_x > draggedWidgetX
                                                                                                        + 5
                                                                                                        || MouseHandler.MouseHandler_x < draggedWidgetX
                                                                                                                - 5
                                                                                                        || MouseHandler.MouseHandler_y > draggedWidgetY
                                                                                                                + 5
                                                                                                        || MouseHandler.MouseHandler_y < draggedWidgetY
                                                                                                                - 5)) {
                                                                                            field492 = true;
                                                                                    ...
                                                                                    if (Scene.shouldSendWalk()) {
                                                                                        ...
                                                                                        var18 = Renderable
                                                                                                .getPacketBufferNode(
                                                                                                        ClientPacket.field2526,
                                                                                                        packetWriter.isaacCipher);
                                                                                        var18.packetBuffer.writeByte(5);
                                                                                        var18.packetBuffer.writeShort(
                                                                                                var4 + ParamComposition.baseX);
                                                                                        var18.packetBuffer.writeByteA(
                                                                                                keyHandlerInstance
                                                                                                        .getKeyPressed(
                                                                                                                82) ? (keyHandlerInstance.getKeyPressed(81) ? 2 : 1) : 0);
                                                                                        var18.packetBuffer.writeShort(
                                                                                                var5 + baseY);
                                                                                        packetWriter.addNode(var18);
                                                                                        Scene.method1224();
                                                                                    ...
                                                                                    if (var41 != KeyHandler.mousedOverWidgetIf1) {
                                                                                        ...
                                                                                        if (KeyHandler.mousedOverWidgetIf1 != null) {
                                                                                            LoginScreenAnimation
                                                                                                    .invalidateWidget(
                                                                                                            KeyHandler.mousedOverWidgetIf1);
                                                                                        }
                                                                                    }

                                                                                    if (var33 != class18.field60
                                                                                            && field533 == field534) {
                                                                                        if (var33 != null) {
                                                                                            LoginScreenAnimation
                                                                                                    .invalidateWidget(
                                                                                    ...
                                                                                    if (oculusOrbState == 0) {
                                                                                        ...
                                                                                        if (class245.oculusOrbFocalPointX
                                                                                                - var4 < -500
                                                                                                || class245.oculusOrbFocalPointX
                                                                                                        - var4 > 500
                                                                                                || UserComparator10.oculusOrbFocalPointY
                                                                                                        - var5 < -500
                                                                                                || UserComparator10.oculusOrbFocalPointY
                                                                                                        - var5 > 500) {
                                                                                        ...
                                                                                        var8 = GrandExchangeOfferNameComparator
                                                                                                .getTileHeight(
                                                                                                        class245.oculusOrbFocalPointX,
                                                                                                        UserComparator10.oculusOrbFocalPointY,
                                                                                                        class103.Client_plane);
                                                                                        ...
                                                                                        if (var6 > 3 && var7 > 3
                                                                                            ...
                                                                                            for (var10 = var6
                                                                                                ...
                                                                                                for (var11 = var7
                                                                                                    ...
                                                                                                    if (var12 < 3
                                                                                                            && (Tiles.Tiles_renderFlags[1][var10][var11]
                                                                                                                    & 2) == 2) {
                                                                                                        ++var12;
                                                                                                    }

                                                                                                    int var26 = var8
                                                                                                            - Tiles.Tiles_heights[var12][var10][var11];
                                                                                                    if (var26 > var9) {
                                                                                                        var9 = var26;
                                                                                                    }
                                                                                                }
                                                                                        ...
                                                                                        Ignored.field3716 = GrandExchangeOfferNameComparator
                                                                                                .getTileHeight(
                                                                                                        class387.localPlayer.x,
                                                                                                        class387.localPlayer.y,
                                                                                                        class103.Client_plane)
                                                                                                - camFollowHeight;
                                                                                        ...
                                                                                        var6 = 0;
                                                                                        if (var37 >= 0 || var36 != 0) {
                                                                                            var6 = keyHandlerInstance
                                                                                                    .getKeyPressed(81)
                                                                                                            ? oculusOrbSlowedSpeed
                                                                                                                    * -237513411
                                                                                                                    * 293972501
                                                                                                            : oculusOrbNormalSpeed
                                                                                                                    * 850633261
                                                                                                                    * -134546011;
                                                                                            var6 *= 16;
                                                                                            field458 = var37;
                                                                                        ...
                                                                                        if (field457 > 0) {
                                                                                            ...
                                                                                            if (field458 >= 0) {
                                                                                                ...
                                                                                                class245.oculusOrbFocalPointX += var8
                                                                                                        * var7 / 65536;
                                                                                                UserComparator10.oculusOrbFocalPointY += var9
                                                                                                        * var7 / 65536;
                                                                                            }

                                                                                            if (field399 != 0) {
                                                                                                Ignored.field3716 += var7
                                                                                                        * field399;
                                                                                        ...
                                                                                        mouseCamClickedY = var4 != -1
                                                                                                && var4 != 1
                                                                                                        ...
                                                                                                        : MouseHandler.MouseHandler_y
                                                                                                                * 361628717
                                                                                                                * -278205531;
                                                                                        var5 = mouseCamClickedX
                                                                                                - MouseHandler.MouseHandler_x;
                                                                                        camAngleDY = var5 * 2;
                                                                                        mouseCamClickedX = var5 != -1
                                                                                                && var5 != 1
                                                                                                        ? (mouseCamClickedX
                                                                                                                + MouseHandler.MouseHandler_x)
                                                                                                                / 2
                                                                                    ...
                                                                                    if (field631) {
                                                                                        ...
                                                                                        var4 = Occluder.cameraMoveToX
                                                                                                * 128 + 64;
                                                                                        var5 = class108.cameraMoveToY
                                                                                                * 128 + 64;
                                                                                        var6 = GrandExchangeOfferNameComparator
                                                                                                .getTileHeight(var4,
                                                                                                        var5,
                                                                                                        class103.Client_plane)
                                                                                                - class10.cameraMoveToHeight;
                                                                                        class275.method1525(var4, var6,
                                                                                                var5);
                                                                                        var4 = WorldMapData_0.cameraLookAtX
                                                                                                * 128 + 64;
                                                                                        var5 = Players.cameraLookAtY
                                                                                                * 128 + 64;
                                                                                        var6 = GrandExchangeOfferNameComparator
                                                                                                .getTileHeight(var4,
                                                                                                        var5,
                                                                                                        class103.Client_plane)
                                                                                                - FloorOverlayDefinition.cameraLookAtHeight;
                                                                                        var7 = var4
                                                                                                - ClanSettings.cameraX;
                                                                                        var8 = var6
                                                                                                - UserComparator10.cameraY;
                                                                                    ...
                                                                                    if (var4 > 15000 && var5 > 15000) {
                                                                                        ...
                                                                                        var27 = Renderable
                                                                                                .getPacketBufferNode(
                                                                                                        ClientPacket.field2508,
                                                                                                        packetWriter.isaacCipher);
                                                                                        packetWriter.addNode(var27);
                                                                                    }

                                                                                    WorldMapElement.friendSystem
                                                                                            .processFriendUpdates();

                                                                                    for (var7 = 0; var7 < field661
                                                                                            .size(); ++var7) {
                                                                                        if (class70.method420(
                                                                                                (Integer) field661.get(
                                                                                                        var7)) != 2) {
                                                                        ...
                                                                        var43 = class133
                                                                                .getWidget(var46.field1818.parentId);
                                                                    } while (var43 == null || var43.children == null
                                                                            || var43.children.length == 0
                                                                            || var46.field1818.childIndex >= var43.children.length
                                                                            || var46.field1818 != var43.children[var46.field1818.childIndex]);

                                                                    if (var46.field1818.type == 11
                                                                            && var46.field1815 == 0) {
                                                                        switch (var46.field1818.method1741()) {
                                                                        case 0:
                                                                            AttackOption.openURL(
                                                                                    var46.field1818.method1748(), true,
                                                                                    false);
                                                                            break;
                                                                        case 1:
                                                                            if (NewShit.method952(class173
                                                                                    .getWidgetFlags(var46.field1818))) {
                                                                                int[] var45 = var46.field1818
                                                                                        .method1751();
                                                                                if (var45 != null) {
                                                                                    var18 = Renderable
                                                                                            .getPacketBufferNode(
                                                                                                    ClientPacket.field2532,
                                                                                                    packetWriter.isaacCipher);
                                                                                    var18.packetBuffer
                                                                                            .method2441(var45[2]);
                                                                                    var18.packetBuffer
                                                                                            .method2414(var45[1]);
                                                                                    var18.packetBuffer
                                                                                            .writeInt(var46.field1818
                                                                                                    .method1757());
                                                                                    var18.packetBuffer.method2382(
                                                                                            var46.field1818.id);
                                                                                    var18.packetBuffer.writeShortLEA(
                                                                                            var46.field1818.childIndex);
                                                                                    var18.packetBuffer
                                                                                            .method2414(var45[0]);
                                                                                    packetWriter.addNode(var18);
                                                                                }
                                                                        ...
                                                                        if (var44 != null && var44.method1663()) {
                                                                            ...
                                                                            case 0:
                                                                                ...
                                                                                var44.method1671(var46.field1816,
                                                                                        var46.field1817,
                                                                                        keyHandlerInstance
                                                                                                .getKeyPressed(82),
                                                                                        keyHandlerInstance
                                                                                ...
                                                                                break;
                                                                            case 1:
                                                                                var44.method1706(var46.field1816,
                                                                                        var46.field1817);
                                                                            }
                                                                        }
                                                                    }
                                                    ...
                                                    } while (var42 == null || var42.children == null
                                                            || var43.childIndex >= var42.children.length
                                                            || var43 != var42.children[var43.childIndex]);
                    ...
                    var31.packetBuffer.writeByte(0);
                    var3 = var31.packetBuffer.offset;
                    ReflectionCheck.performReflectionCheck(var31.packetBuffer);
                    var31.packetBuffer.method2434(var31.packetBuffer.offset - var3);
                    packetWriter.addNode(var31);
                }
            }
            ...
            if (viewportX != -1) {
                ...
                if ((menuOptionsCount >= 2 || isItemSelected != 0 || isSpellSelected) && showMouseOverText) {
                    ...
                    if (menuOptionsCount > 2) {
                        var5 = var5 + class149.colorStartTag(16777215) + " " + '/' + " " + (menuOptionsCount - 2)
                                + " more options";
                    }
        ...
        if (var2 == null) {
            ...
            try {
                ...
                if (ServerPacket.field2665 == var1.serverPacket) {
                    ...
                    var9 = var66 + var7;
                    var10 = var62 + var23;
                    if (var7 >= 0 && var23 >= 0 && var7 < 104 && var23 < 104 && var9 >= 0 && var10 >= 0 && var9 < 104
                            && var10 < 104 && var12 != 65535) {
                        var7 = var7 * 128 + 64;
                        var23 = var23 * 128 + 64;
                        var9 = var9 * 128 + 64;
                        var10 = var10 * 128 + 64;
                        var19 = new Projectile(var12, class103.Client_plane, var7, var23,
                                GrandExchangeOfferNameComparator.getTileHeight(var7, var23, class103.Client_plane)
                                        - var13,
                                var15 + cycle, var16 + cycle, var17, var18, var64, var14);
                        var19.setDestination(var9, var10,
                                GrandExchangeOfferNameComparator.getTileHeight(var9, var10, class103.Client_plane)
                                        - var14,
                                var15 + cycle);
                ...
                if (ServerPacket.field2563 == var1.serverPacket) {
                    ...
                    if (UserComparator7.cameraMoveToAcceleration >= 100) {
                        ...
                        UserComparator10.cameraY = GrandExchangeOfferNameComparator.getTileHeight(ClanSettings.cameraX,
                                class366.cameraZ, class103.Client_plane) - class10.cameraMoveToHeight;
                    }
                ...
                if (ServerPacket.field2599 == var1.serverPacket) {
                    ...
                    PlayerType var88 = (PlayerType) class4.findEnumerated(ArchiveLoader.PlayerType_values(),
                    ...
                    if (var92 == null) {
                        ...
                        while (true) {
                            if (var15 >= 100) {
                                if (var88.isUser && WorldMapElement.friendSystem
                                        .isIgnored(new Username(var24, WorldMapCacheName.loginType))) {
                                    var68 = true;
                                }
                                break;
                            }
                    ...
                    if (!var68) {
                        ...
                        var16 = var84 >= 0 ? 41 : 44;
                        if (var88.modIcon != -1) {
                            class134.addChatMessage(var16, ObjectSound.addImageTag(var88.modIcon) + var24, var33,
                                    var92.name);
                        } else {
                ...
                if (ServerPacket.field2652 == var1.serverPacket) {
                    ...
                    for (var74 = (InterfaceParent) interfaceParents
                            .first(); var74 != null; var74 = (InterfaceParent) interfaceParents.next()) {
                        if (var74.field854) {
                ...
                if (ServerPacket.field2650 == var1.serverPacket) {
                    ...
                    if (var75 != null) {
                        ...
                        } else if (var5 == -1 || var75.sequence == -1
                                || class85.SequenceDefinition_get(var5).forcedPriority >= class85
                                        .SequenceDefinition_get(var75.sequence).forcedPriority) {
                            var75.sequence = var5;
                            var75.sequenceFrame = 0;
                            var75.sequenceFrameCycle = 0;
                            var75.sequenceDelay = var21;
                ...
                if (ServerPacket.field2670 == var1.serverPacket) {
                    ...
                    if (var7 >= 0 && var23 >= 0 && var7 < 104 && var23 < 104) {
                        var7 = var7 * 128 + 64;
                        var23 = var23 * 128 + 64;
                        GraphicsObject var94 = new GraphicsObject(var9, class103.Client_plane, var7, var23,
                                GrandExchangeOfferNameComparator.getTileHeight(var7, var23, class103.Client_plane)
                                        - var10,
                                var64, cycle);
                ...
                if (ServerPacket.field2604 == var1.serverPacket) {
                    ...
                    if (AttackOption.cameraLookAtAcceleration >= 100) {
                        ...
                        var21 = GrandExchangeOfferNameComparator.getTileHeight(var20, var5, class103.Client_plane)
                                - FloorOverlayDefinition.cameraLookAtHeight;
                        var7 = var20 - ClanSettings.cameraX;
                        var23 = var21 - UserComparator10.cameraY;
                        var9 = var5 - class366.cameraZ;
                        var10 = (int) Math.sqrt((double) (var7 * var7 + var9 * var9));
                        class103.cameraPitch = (int) (Math.atan2((double) var23, (double) var10) * 325.9490051269531D)
                                & 2047;
                        class285.cameraYaw = (int) (Math.atan2((double) var7, (double) var9) * -325.9490051269531D)
                                & 2047;
                ...
                if (ServerPacket.field2583 == var1.serverPacket) {
                    ...
                    if (var5 != var76.rawX || var21 != var76.rawY || var76.xAlignment != 0 || var76.yAlignment != 0) {
                        ...
                        if (var76.type == 0) {
                            AbstractWorldMapData.revalidateWidgetScroll(
                                    WorldMapLabel.Widget_interfaceComponents[var20 >> 16], var76, false);
                        }
                    }
                ...
                if (ServerPacket.field2584 == var1.serverPacket) {
                    ...
                    PlayerType var41 = (PlayerType) class4.findEnumerated(ArchiveLoader.PlayerType_values(),
                            var3.readUnsignedByte());
                ...
                if (ServerPacket.field2629 == var1.serverPacket) {
                    ...
                    PlayerType var95 = (PlayerType) class4.findEnumerated(ArchiveLoader.PlayerType_values(),
                            var3.readUnsignedByte());
                    ...
                    if (var95.isUser && WorldMapElement.friendSystem
                            .isIgnored(new Username(var50, WorldMapCacheName.loginType))) {
                        var67 = true;
                    }
                    ...
                    if (!var67 && field494 == 0) {
                        ...
                        if (var95.modIcon != -1) {
                            class134.addChatMessage(9, ObjectSound.addImageTag(var95.modIcon) + var50, var33,
                                    WorldMapSection1.base37DecodeLong(var37));
                        } else {
                ...
                if (ServerPacket.field2574 == var1.serverPacket) {
                    ReflectionCheck.readReflectionCheck(var3, var1.serverPacketLength);
                    var1.serverPacket = null;
                    return true;
                }
                ...
                if (ServerPacket.field2601 == var1.serverPacket) {
                    ...
                    for (; var3.offset < var1.serverPacketLength; CollisionMap.itemContainerSetItem(var5, var7,
                            var23 - 1, var9)) {
                ...
                if (ServerPacket.field2657 == var1.serverPacket) {
                    ...
                    if (var7 >= 0 && var23 >= 0 && var7 < 103 && var23 < 103) {
                        if (var12 == 0) {
                            BoundaryObject var91 = WorldMapAreaData.scene.method1200(class103.Client_plane, var7,
                                    var23);
                            if (var91 != null) {
                                var15 = class124.Entity_unpackID(var91.tag);
                                if (var10 == 2) {
                                    var91.renderable1 = new DynamicObject(var15, 2, var64 + 4, class103.Client_plane,
                                            var7, var23, var13, false, var91.renderable1);
                                    var91.renderable2 = new DynamicObject(var15, 2, var64 + 1 & 3,
                                            class103.Client_plane, var7, var23, var13, false, var91.renderable2);
                                } else {
                                    var91.renderable1 = new DynamicObject(var15, var10, var64, class103.Client_plane,
                                            var7, var23, var13, false, var91.renderable1);
                                }
                            }
                        } else if (var12 == 1) {
                            WallDecoration var90 = WorldMapAreaData.scene.method1201(class103.Client_plane, var7,
                                    var23);
                            if (var90 != null) {
                                var15 = class124.Entity_unpackID(var90.tag);
                                if (var10 != 4 && var10 != 5) {
                                    if (var10 == 6) {
                                        var90.renderable1 = new DynamicObject(var15, 4, var64 + 4,
                                                class103.Client_plane, var7, var23, var13, false, var90.renderable1);
                                    } else if (var10 == 7) {
                                        var90.renderable1 = new DynamicObject(var15, 4, (var64 + 2 & 3) + 4,
                                                class103.Client_plane, var7, var23, var13, false, var90.renderable1);
                                    } else if (var10 == 8) {
                                        var90.renderable1 = new DynamicObject(var15, 4, var64 + 4,
                                                class103.Client_plane, var7, var23, var13, false, var90.renderable1);
                                        var90.renderable2 = new DynamicObject(var15, 4, (var64 + 2 & 3) + 4,
                                                class103.Client_plane, var7, var23, var13, false, var90.renderable2);
                                    }
                                } else {
                                    var90.renderable1 = new DynamicObject(var15, 4, var64, class103.Client_plane, var7,
                                            var23, var13, false, var90.renderable1);
                                }
                            }
                        } else if (var12 == 2) {
                            ...
                            if (var32 != null) {
                                var32.renderable = new DynamicObject(class124.Entity_unpackID(var32.tag), var10, var64,
                                        class103.Client_plane, var7, var23, var13, false, var32.renderable);
                            }
                        } else if (var12 == 3) {
                            FloorDecoration var89 = WorldMapAreaData.scene.getFloorDecoration(class103.Client_plane,
                                    var7, var23);
                            if (var89 != null) {
                                var89.renderable = new DynamicObject(class124.Entity_unpackID(var89.tag), 22, var64,
                                        class103.Client_plane, var7, var23, var13, false, var89.renderable);
                            }
                        }
                    }
                ...
                if (ServerPacket.field2669 == var1.serverPacket) {
                    ...
                    if (var8 != null) {
                        LoginScreenAnimation.invalidateWidget(var8);
                        AbstractWorldMapData.revalidateWidgetScroll(
                                WorldMapLabel.Widget_interfaceComponents[var8.id >>> 16], var8, true);
                    }
                ...
                if (ServerPacket.field2571 == var1.serverPacket) {
                    ...
                    for (PendingSpawn var51 = (PendingSpawn) pendingSpawns
                            .last(); var51 != null; var51 = (PendingSpawn) pendingSpawns.previous()) {
                        if (var51.x >= class373.field3599 && var51.x < class373.field3599 + 8
                                && var51.y >= KeyHandler.field86 && var51.y < KeyHandler.field86 + 8
                                && var51.plane == class103.Client_plane) {
                            var51.endCycle = 0;
                        }
                    }
                ...
                if (ServerPacket.field2628 == var1.serverPacket) {
                    ...
                    PacketBufferNode var22 = Renderable.getPacketBufferNode(ClientPacket.field2439,
                            packetWriter.isaacCipher);
                ...
                class121.RunException_sendStackTrace(
                        "" + (var1.serverPacket != null ? var1.serverPacket.id * 618004529 * -1282844463 : -1) + ","
                                + (var1.field1133 != null ? var1.field1133.id * 618004529 * -1282844463 : -1) + ","
                                + (var1.field1134 != null ? var1.field1134.id * 618004529 * -1282844463 : -1) + ","
                ...
                var24 = "" + (var1.serverPacket != null ? var1.serverPacket.id * 618004529 * -1282844463 : -1) + ","
                        + (var1.field1133 != null ? var1.field1133.id * 618004529 * -1282844463 : -1) + ","
                        + (var1.field1134 != null ? var1.field1134.id * 618004529 * -1282844463 : -1) + ","
                        + var1.serverPacketLength + "," + (class387.localPlayer.pathX[0] + ParamComposition.baseX) + ","
                        + (class387.localPlayer.pathY[0] + baseY) + ",";
            ...
            if (clickedWidget == null) {
                ...
                if (isMenuOpen) {
                    ...
                    if (var1 != 1 && (ClanMate.mouseCam || var1 != 4)) {
                        ...
                        if (var2 < class130.menuX - 10 || var2 > class130.menuX + class7.menuWidth + 10
                                || var3 < ModeWhere.menuY - 10 || var3 > PlayerType.menuHeight + ModeWhere.menuY + 10) {
                            isMenuOpen = false;
                            Language.method1878(class130.menuX, ModeWhere.menuY, class7.menuWidth,
                                    PlayerType.menuHeight);
                        }
                    }
                    ...
                    if ((var1 == 1 || !ClanMate.mouseCam && var1 == 4) && var2 >= 0) {
                        ...
                        if (var4 == 39 || var4 == 40 || var4 == 41 || var4 == 42 || var4 == 43 || var4 == 33
                            ...
                            if (ViewportMouse.method1295(class173.getWidgetFlags(var10))
                                    || class16.method58(class173.getWidgetFlags(var10))) {
                                if (WorldMapLabelSize.dragInventoryWidget != null && !field492 && menuOptionsCount > 0
                                        && !this.shouldLeftClickOpenMenu()) {
    ...
    final void method370() {
        ...
        if (field563 && field560) {
            ...
            if (class27.widgetDragDuration > clickedWidget.dragThreshold
            ...
            if (MouseHandler.MouseHandler_currentButton == 0) {
                if (isDraggingWidget) {
                    ...
                    if (draggedOnWidget != null) {
                        ...
                        if (var13 != null) {
                            PacketBufferNode var12 = Renderable.getPacketBufferNode(ClientPacket.field2487,
                                    packetWriter.isaacCipher);
        ...
        if (this.checkHost()) {
            ...
            for (int var1 = 0; var1 <= 28; ++var1) {
                ...
                if (var2 != null) {
                    ...
                    case 7:
                        var4 = Integer.parseInt(var2);
                        GameBuild[] var5 = new GameBuild[] { GameBuild.WIP, GameBuild.RC, GameBuild.LIVE,
                                GameBuild.BUILDLIVE };
                        GameBuild[] var6 = var5;
                        var7 = 0;
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        class134.field1270 = (StudioGame) class4.findEnumerated(WorldMapSection1.method1466(),
            ...
            try {
                ...
                class158.cacheParentPaths = new String[] { "c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/",
                        "c:/", UserComparator4.userHomeDirectory, "/tmp/", "" };
                class130.cacheSubPaths = new String[] { ".jagex_cache_" + class86.cacheGamebuild,
                        ".file_store_" + class86.cacheGamebuild };
                var3 = 0;

                label342: while (var3 < 4) {
                    String var41 = var3 == 0 ? "" : "" + var3;
                    UserComparator5.JagexCache_locationFile = new File(UserComparator4.userHomeDirectory,
                            "jagex_cl_oldschool_" + var18 + var41 + ".dat");
                    String var43 = null;
                    String var20 = null;
                    boolean var21 = false;
                    Buffer var10;
                    ...
                    if (UserComparator5.JagexCache_locationFile.exists()) {
                        try {
                            ...
                            for (var10 = new Buffer(
                                    (int) var9.length()); var10.offset < var10.array.length; var10.offset += var11) {
                    ...
                    if (var43 == null && var3 == 0) {
                        label318: for (int var23 = 0; var23 < class130.cacheSubPaths.length; ++var23) {
                            for (int var24 = 0; var24 < class158.cacheParentPaths.length; ++var24) {
                                File var25 = new File(class158.cacheParentPaths[var24] + class130.cacheSubPaths[var23]
                    ...
                    if (var43 == null) {
                        var43 = UserComparator4.userHomeDirectory + File.separatorChar + "jagexcache" + var41
                                + File.separatorChar + "oldschool" + File.separatorChar + var18 + File.separatorChar;
                        var21 = true;
                    }
                ...
                try {
                    ...
                    if (var54.exists()) {
                        ...
                        label271: for (var4 = 0; var4 < class130.cacheSubPaths.length; ++var4) {
                            for (var29 = 0; var29 < class158.cacheParentPaths.length; ++var29) {
                                File var48 = new File(class158.cacheParentPaths[var29] + class130.cacheSubPaths[var4]
                                        + File.separatorChar + "random.dat");
                                if (var48.exists()) {
                                    JagexCache.JagexCache_randomDat = new BufferedFile(new AccessFile(var48, "rw", 25L),
                                            24, 0);
                                    break label271;
                                }
                            }
                ...
                JagexCache.JagexCache_dat2File = new BufferedFile(
                        new AccessFile(class372.getFile("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
                JagexCache.JagexCache_idx255File = new BufferedFile(
                        new AccessFile(class372.getFile("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
                class18.JagexCache_idxFiles = new BufferedFile[JagexCache.idxCount];

                for (var3 = 0; var3 < JagexCache.idxCount; ++var3) {
                    class18.JagexCache_idxFiles[var3] = new BufferedFile(
                            new AccessFile(class372.getFile("main_file_cache.idx" + var3), "rw", 1048576L), 6000, 0);
                }
