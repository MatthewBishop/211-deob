    ...
    static void runScript(ScriptEvent var0, int var1, int var2) {
        ...
        if (var4 != null) {
            ...
            label960: {
                label961: {
                    try {
                        ...
                        try {
                            ...
                            for (var13 = 1; var13 < var3.length; ++var13) {
                                if (var3[var13] instanceof Integer) {
                                    ...
                                    if (var14 == -2147483643) {
                                        var14 = var0.widget != null ? var0.widget.childIndex * 1171460333 * -1779839771
                                                : -1;
                                    }

                                    if (var14 == -2147483642) {
                                        var14 = var0.dragTarget != null ? var0.dragTarget.id * -1493443793 * -62043185
                                                : -1;
                                    }

                                    if (var14 == -2147483641) {
                                        var14 = var0.dragTarget != null
                                                ? var0.dragTarget.childIndex * 1171460333 * -1779839771
                                                : -1;
                                    }
                            ...
                            label934: while (true) {
                                ...
                                if (var33 >= 100) {
                                    ...
                                    if (Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize] != Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize
                                            + 1]) {
                                        var20 += var7[var20];
                                    }
                                } else if (var33 == 8) {
                                    ...
                                    var13 = var7[var20];
                                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                            - 1] = SecureRandomFuture.getVarbit(var13);
                                } else if (var33 == 27) {
                                    var13 = var7[var20];
                                    WorldMapEvent.method1503(var13,
                                            Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                                } else if (var33 == 31) {
                                    class302.Interpreter_intStackSize -= 2;
                                    if (Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize
                                    ...
                                    Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
                                            - 1] = SecureRandomFuture.Interpreter_stringLocals[var7[var20]];
                                } else if (var33 == 36) {
                                    ...
                                    var21 = class312.method1765(Interpreter.Interpreter_stringStack,
                                            class20.Interpreter_stringStackSize, var13);
                                    Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
                                            - 1] = var21;
                                } else if (var33 == 38) {
                                    ...
                                    if (var33 != 40) {
                                        if (var33 == 42) {
                                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                    - 1] = class9.varcs.getInt(var7[var20]);
                                        } else if (var33 == 43) {
                                            class9.varcs.setInt(var7[var20],
                                                    Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                                        } else if (var33 == 44) {
                                            var13 = var7[var20] >> 16;
                                            var14 = var7[var20] & '\uffff';
                                            ...
                                            Interpreter.Interpreter_arrays[var13][var14] = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize
                                                    + 1];
                                        } else {
                                            String var22;
                                            if (var33 == 47) {
                                                ...
                                                class9.varcs.setStringOld(var7[var20],
                                                        Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize]);
                                            } else if (var33 == 49) {
                                                ...
                                                class9.varcs.setString(var7[var20],
                                                        Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize]);
                                            } else if (var33 == 60) {
                                                IterableNodeHashTable var38 = var4.switches[var7[var20]];
                                                IntegerNode var37 = (IntegerNode) var38.get(
                                                        (long) Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                                                if (var37 != null) {
                                                    var20 += var37.integer;
                                                }
                                            } else {
                        ...
                        if (var30) {
                            while (Interpreter.field714.size() > 0) {
                                ...
                                class16.widgetDefaultMenuAction(var19.method584(), var19.method581(), var19.method582(),
                                        var19.method583(), "");
                            }
                            ...
                            if (!var9 && var2 > 0 && var10 >= var2) {
                                class121.RunException_sendStackTrace("Warning: Script " + var4.field807
                    ...
                    while (Interpreter.field714.size() > 0) {
                        ...
                        class16.widgetDefaultMenuAction(var26.method584(), var26.method581(), var26.method582(),
                                var26.method583(), "");
                    }
                ...
                while (Interpreter.field714.size() > 0) {
                    ...
                    class16.widgetDefaultMenuAction(var34.method584(), var34.method581(), var34.method582(),
                            var34.method583(), "");
                }
                ...
                if (!var9 && var2 > 0 && var10 >= var2) {
                    class121.RunException_sendStackTrace(
                            "Warning: Script " + var4.field807 + " finished at op count " + var10 + " of max " + var1,
                            (Throwable) null);
                }
            ...
            while (Interpreter.field714.size() > 0) {
                ...
                class16.widgetDefaultMenuAction(var41.method584(), var41.method581(), var41.method582(),
                        var41.method583(), "");
            }
