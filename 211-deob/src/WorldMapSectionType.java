public enum WorldMapSectionType implements class349 {
    ...
    static void method1441(Font var0, Font var1) {
        ...
        if (StudioGame.worldSelectLeftSprite == null) {
            StudioGame.worldSelectLeftSprite = VarcInt.SpriteBuffer_getIndexedSpriteByName(WorldMapEvent.archive8,
                    "leftarrow", "");
        }

        if (class205.worldSelectRightSprite == null) {
            class205.worldSelectRightSprite = VarcInt.SpriteBuffer_getIndexedSpriteByName(WorldMapEvent.archive8,
                    "rightarrow", "");
        }
        ...
        if (class491.worldSelectBackSprites != null) {
            ...
            if (StudioGame.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
                StudioGame.worldSelectLeftSprite.drawAt(8,
                        class127.canvasHeight / 2 - StudioGame.worldSelectLeftSprite.subHeight / 2);
            }

            if (class205.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
                class205.worldSelectRightSprite.drawAt(
                        GameEngine.canvasWidth - class205.worldSelectRightSprite.subWidth - 8,
                        class127.canvasHeight / 2 - class205.worldSelectRightSprite.subHeight / 2);
            }
            ...
            for (var16 = var5 * var15; var16 < World.World_count && var15 - Login.worldSelectPage < var4; ++var16) {
                ...
                if (class307.worldSelectFlagSprites != null) {
                    class307.worldSelectFlagSprites[(var17.isMembersOnly() ? 8 : 0) + var17.location].drawAt(var12 + 29,
                            var11);
                }
            ...
            if (var14) {
                ...
                Rasterizer2D.Rasterizer2D_drawRectangle(MouseHandler.MouseHandler_x - var16 / 2, var25, var16, var24,
                        0);
                var1.drawCentered(class88.World_worlds[Login.hoveredWorldIndex].activity, MouseHandler.MouseHandler_x,
    ...
    static final void drawMinimap(Widget var0, int var1, int var2, int var3) {
        ...
        if (var4 != null) {
            ...
            if (Client.minimapState != 2 && Client.minimapState != 5) {
                ...
                class31.sceneMinimapSprite.drawRotatedMaskedCenteredAround(var1, var2, var4.width, var4.height, var6,
                ...
                for (var10 = 0; var10 < var8; ++var10) {
                    ...
                    if (var16 != null && var16.isVisible() && !var16.isHidden && var16 != class387.localPlayer) {
                        ...
                        } else if (class387.localPlayer.team != 0 && var16.team != 0
                                && var16.team == class387.localPlayer.team) {
                ...
                if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
                    if (Client.hintArrowType == 1 && Client.hintArrowNpcIndex >= 0
                        ...
                        if (var19 != null) {
                            ...
                            class361.worldToMinimap(var1, var2, var11, var12, UserComparator6.mapMarkerSprites[1],
                                    var4);
                        }
                    }
