            ...
            while (true) {
                ...
                if (var7 == 0) {
                    if (var1 == 0) {
                        ...
                        int var13 = class4.method4(var11 + '넵', var12 + 91923, 4) - 128
                                + (class4.method4(var11 + 10294, var12 + '鎽', 2) - 128 >> 1)
                                + (class4.method4(var11, var12, 1) - 128 >> 2);
                ...
                if (var7 <= 49) {
                    class172.Tiles_overlays[var1][var2][var3] = Client.param25 < 209 ? (short) var0.readByte()
                            : (short) var0.readShort();
