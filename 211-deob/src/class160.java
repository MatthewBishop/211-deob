...
public class class160 {
        ...
        if (var0 == 4100) {
            ...
            if (var0 == 4101) {
                ...
                Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var3
                        + ParamComposition.intToString(var4, true);
                return 1;
            } else if (var0 == 4103) {
                var3 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
                ...
                if (var0 == 4104) {
                    ...
                    Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var6 + "-"
                            + Interpreter.Interpreter_MONTHS[var17] + "-" + var8;
                    return 1;
                } else if (var0 != 4105) {
                    if (var0 == 4106) {
                        var10 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                        Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = Integer
                                .toString(var10);
                        return 1;
                    } else if (var0 == 4107) {
                        class20.Interpreter_stringStackSize -= 2;
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = AbstractArchive
                                .method1838(Projectile.compareStrings(
                        ...
                        if (var0 == 4108) {
                            ...
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var14
                                    .lineCount(var3, var4);
                            return 1;
                        } else if (var0 == 4109) {
                            var3 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
                            ...
                            var10 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class126
                                    .isCharPrintable((char) var10) ? 1 : 0;
                            return 1;
                        } else if (var0 == 4114) {
                            var10 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class97
                                    .isAlphaNumeric((char) var10) ? 1 : 0;
                            return 1;
                        } else if (var0 == 4115) {
                            var10 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class155
                                    .isCharAlphabetic((char) var10) ? 1 : 0;
                            return 1;
                        } else if (var0 == 4116) {
                            var10 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = CollisionMap
                            ...
                            Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var18
                                    .toString();
                            return 1;
                        } else if (var0 == 4120) {
                            var3 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
    ...
    static void setWindowedMode(int var0) {
        ...
        if (Client.gameState >= 25) {
            PacketBufferNode var1 = Renderable.getPacketBufferNode(ClientPacket.field2494,
    ...
    static final void clanKickUser(String var0) {
        if (class463.friendsChat != null) {
            PacketBufferNode var1 = Renderable.getPacketBufferNode(ClientPacket.field2434,
                    Client.packetWriter.isaacCipher);
