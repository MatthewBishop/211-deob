public class class217 {
    ...
    static int method1182(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 3100) {
            ...
            PendingSpawn.performPlayerAnimation(class387.localPlayer,
            ...
            if (var0 == 3104) {
                ...
                PacketBufferNode var12 = Renderable.getPacketBufferNode(ClientPacket.field2516,
                ...
                if (var0 == 3105) {
                    ...
                    if (var0 == 3107) {
                        ...
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                - 1] = PacketWriter.clientPreferences.getRoofsHidden() ? 1 : 0;
                        return 1;
                    } else if (var0 == 3112) {
                        PacketWriter.clientPreferences.setRoofsHidden(
                                Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1);
                        return 1;
                    } else if (var0 == 3113) {
                        var3 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
                        ...
                        if (var7.length() > 500) {
                            ...
                            PacketBufferNode var6 = Renderable.getPacketBufferNode(ClientPacket.field2498,
                                    Client.packetWriter.isaacCipher);
                            var6.packetBuffer.writeShort(1 + class96.stringCp1252NullTerminatedByteSize(var7)
                                    + class96.stringCp1252NullTerminatedByteSize(var5));
                        ...
                        class237.setTapToDrop(
                                Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1);
                        return 1;
                    } else if (var0 == 3128) {
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Language
                                .getTapToDrop() ? 1 : 0;
                        return 1;
                    } else if (var0 == 3129) {
                        class302.Interpreter_intStackSize -= 2;
                        Client.oculusOrbNormalSpeed = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
                        Client.oculusOrbSlowedSpeed = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize
                                + 1];
                        return 1;
                    } else if (var0 == 3130) {
                        class302.Interpreter_intStackSize -= 2;
                        ...
                        Client.field662 = 3;
                        Client.field545 = var2 ? Interpreter.scriptDotWidget.id * -1493443793 * -62043185
                                : class85.scriptActiveWidget.id * -1493443793 * -62043185;
                        return 1;
                    } else {
                        boolean var15;
                        if (var0 == 3141) {
                            ...
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                    - 1] = PacketWriter.clientPreferences.getIsUsernameHidden() ? 1 : 0;
                            return 1;
                        } else if (var0 == 3143) {
                            var15 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize] == 1;
                            ...
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                    - 1] = PacketWriter.clientPreferences.getTitleMusicDisabled() ? 0 : 1;
                            return 1;
                        } else if (var0 == 3148) {
                            return 1;
                        } else if (var0 == 3149) {
                            ...
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class120
                                    .method670();
                            return 1;
                        } else if (var0 == 3155) {
                            ...
                            LoginScreenAnimation
                                    .method516(Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                            return 1;
                        } else if (var0 == 3182) {
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class463
                                    .method2340();
                            return 1;
                        } else if (var0 == 3189) {
                            var8 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
