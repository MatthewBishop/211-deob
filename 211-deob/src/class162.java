        ...
        if (var0 == 1600) {
            ...
            if (var0 == 1602) {
                if (var3.type == 12) {
                    ...
                    if (var7 != null) {
                        Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var7
                                .method1678().method1941();
                        return 1;
                    }
                }
                ...
                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var3.modelTransparency ? 1
                        : 0;
                return 1;
            } else {
                class302 var4;
                if (var0 == 1617) {
                    ...
                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var4 != null
                            ? var4.field2794 * 1058580729 * -1366058679
                            : 0;
                }
                ...
                if (var0 == 1618) {
                    var4 = var3.method1745();
                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var4 != null
                            ? var4.field2797 * 2101478585 * -318979703
                            : 0;
                    return 1;
                } else if (var0 == 1619) {
                    var7 = var3.method1750();
                    Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = var7 != null
                            ? var7.method1714().method1941()
                            : "";
                    return 1;
                } else if (var0 == 1620) {
                    var4 = var3.method1745();
                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var4 != null
                            ? var4.field2795 * 1069637893 * 781009869
                            : 0;
                    return 1;
                } else if (var0 == 1621) {
                    var7 = var3.method1750();
                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var7 != null
                            ? var7.method1661()
                            : 0;
                    return 1;
                } else if (var0 == 1622) {
                    ...
                    if (var0 == 1626) {
                        ...
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Math.min(var5,
                                var6);
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Math.max(var5,
                                var6);
                        return 1;
                    } else if (var0 == 1628) {
                        var7 = var3.method1750();
                        ...
                        if (var0 == 1633) {
                            ...
                            Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1] = var8 != null
                                    ? var8.method98(
