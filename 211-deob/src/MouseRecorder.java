        ...
        while (true) {
            ...
            if (var6 != var11) {
                label309: {
                    ...
                    int var22;
                    if (var15 == 2
                            && WorldMapAreaData.scene.getObjectFlags(class103.Client_plane, var13, var14, var11) >= 0) {
                        ...
                        for (PendingSpawn var21 = (PendingSpawn) Client.pendingSpawns
                                .last(); var21 != null; var21 = (PendingSpawn) Client.pendingSpawns.previous()) {
                            if (var21.plane == class103.Client_plane && var13 == var21.x && var14 == var21.y
                                    && var18 == var21.id) {
                                var20 = var21;
                                break;
                            }
                        ...
                        if (Client.isItemSelected == 1) {
                            WorldMapManager.insertMenuItemNoShift("Use", Client.selectedItemName + " " + "->" + " "
                                    + class149.colorStartTag(65535) + var19.name, 1, var18, var13, var14);
                        } else if (Client.isSpellSelected) {
                            if ((class149.selectedSpellFlags & 4) == 4) {
                                WorldMapManager
                                        .insertMenuItemNoShift(Client.selectedSpellActionName,
                                                Client.selectedSpellName + " " + "->" + " "
                                                        + class149.colorStartTag(65535) + var19.name,
                                                2, var18, var13, var14);
                            }
                        } else {
                            ...
                            if (var33 != null) {
                                for (var22 = 4; var22 >= 0; --var22) {
                                    if ((var20 == null || var20.method497(var22)) && var33[var22] != null) {
                                        ...
                                        WorldMapManager.insertMenuItemNoShift(var33[var22],
                                                class149.colorStartTag(65535) + var19.name, var23, var18, var13, var14);
                                    }
                                }
                            }

                            WorldMapManager.insertMenuItemNoShift("Examine", class149.colorStartTag(65535) + var19.name,
                                    1002, var19.id, var13, var14);
                        }
                    }
                            ...
                            for (TileItem var32 = (TileItem) var31.first(); var32 != null; var32 = (TileItem) var31
                                ...
                                if (Client.isItemSelected == 1) {
                                    ...
                                    for (int var37 = 4; var37 >= 0; --var37) {
                                        if (var32.method591(var37)) {
                                            if (var28 != null && var28[var37] != null) {
                                                ...
                                                WorldMapManager.insertMenuItemNoShift(var28[var37],
                                                        class149.colorStartTag(16748608) + var36.name, var24, var32.id,
                                                        var13, var14);
                                            } else if (var37 == 2) {
                                                WorldMapManager.insertMenuItemNoShift("Take",
                                                        class149.colorStartTag(16748608) + var36.name, 20, var32.id,
                                                        var13, var14);
                                            }
                                        }
                                    }
                                    ...
                                    WorldMapManager.insertMenuItemNoShift("Examine",
                                            class149.colorStartTag(16748608) + var36.name, 1004, var32.id, var13,
                                            var14);
                                }
                            }
                        }
