        ...
        if (var0 != 7500 && var0 != 7508) {
            if (var0 != 7501) {
                    ...
                    if (var14 == null) {
                        for (var15 = var12; var15 < var13; ++var15) {
                            ...
                            if (var17 == class463.field3985) {
                                ...
                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class370
                                        .method1934(var16);
                            }
                        }
                ...
                if (Canvas.field78 != null && Canvas.field78.hasNext()) {
                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = (Integer) Canvas.field78
                            .next();
                } else {
            ...
            if (var22 == null) {
                ...
                if (Skeleton.field1984 != null) {
                    ...
                    Canvas.field78 = Skeleton.field1984.iterator();
                    if (var0 == 7500) {
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Skeleton.field1984
                                .size();
                    }
                } else {
                    Client.field641 = -1;
