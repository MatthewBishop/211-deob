public class ClanSettings {
    ...
    public static final boolean method796(int var0, int var1, RouteStrategy var2, CollisionMap var3) {
        ...
        while (var11 != var18) {
            ...
            if (var16 < 127 && class209.directions[var16 + 1][var17] == 0
            ...
            if (var17 < 127 && class209.directions[var16][var17 + 1] == 0
            ...
            if (var16 > 0 && var17 > 0 && class209.directions[var16 - 1][var17 - 1] == 0
            ...
            if (var16 < 127 && var17 > 0 && class209.directions[var16 + 1][var17 - 1] == 0
            ...
            if (var16 > 0 && var17 < 127 && class209.directions[var16 - 1][var17 + 1] == 0
            ...
            if (var16 < 127 && var17 < 127 && class209.directions[var16 + 1][var17 + 1] == 0
    ...
    static final void Clan_joinChat(String var0) {
        if (!var0.equals("")) {
            PacketBufferNode var1 = Renderable.getPacketBufferNode(ClientPacket.field2528,
