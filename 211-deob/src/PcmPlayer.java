    ...
    static final void updateActorSequence(Actor var0, int var1) {
        ...
        if (var0.exactMoveArrive1Cycle >= Client.cycle) {
            ...
            if (var0.exactMoveArrive2Cycle >= Client.cycle) {
                boolean var14 = var0.exactMoveArrive2Cycle == Client.cycle || var0.sequence == -1
                        || var0.sequenceDelay != 0;
                if (!var14) {
                ...
                if (var0.pathLength == 0) {
                    ...
                    label615: {
                        ...
                        if (var4 - var2 <= 256 && var4 - var2 >= -256 && var5 - var3 <= 256 && var5 - var3 >= -256) {
                            ...
                            if (var10) {
                                if (var0.orientation != var0.rotation && var0.targetIndex == -1
                                        && var0.field1004 != 0) {
                                    var9 = 2;
                                }
                            ...
                            if (var9 >= 8) {
                                if (var0.movementSequence == var0.walkSequence && var0.runSequence != -1) {
                                    var0.movementSequence = var0.runSequence;
                                        ...
                                        && var0.runBackSequence != -1) {
                                    var0.movementSequence = var0.runBackSequence;
                                } else if (var0.walkLeftSequence == var0.movementSequence
                                        && var0.runLeftSequence != -1) {
                                    var0.movementSequence = var0.runLeftSequence;
                                } else if (var0.movementSequence == var0.walkRightSequence
                                        && var0.runRightSequence != -1) {
        ...
        if (var0.field1004 != 0) {
            ...
            if (var2 != 0) {
                ...
                if (var2 > 1024) {
                    ...
                    if (!var0.instantTurn && var0.movementSequence == var0.idleSequence
                            && (var0.field967 > 25 || var15)) {
            ...
            if (var12 != null) {
                if (!var12.isCachedModelIdSet() && var12.frameIds != null) {
                    ...
                    if (var0.movementFrame < var12.frameIds.length
                            && var0.movementFrameCycle > var12.frameLengths[var0.movementFrame]) {
                    ...
                    if (var0.movementFrame >= var12.frameIds.length) {
                        if (var12.frameCount > 0) {
                            ...
                            if (var0.movementFrame < 0 || var0.movementFrame >= var12.frameIds.length
                                    || var12.field1799 && var0.field976 >= var12.iterations) {
                    ...
                    if (var0.movementFrame < var3) {
                        ...
                        if (var12.frameCount > 0) {
                            ...
                            if (var0.movementFrame < 0 || var0.movementFrame >= var3
                                    || var12.field1799 && var0.field976 >= var12.iterations) {
                                var0.movementFrame = 0;
                                var0.movementFrameCycle = 0;
                                var0.field976 = 0;
        ...
        if (var0.spotAnimation != -1 && Client.cycle >= var0.spotAnimationStartCycle) {
            ...
            if (var2 != -1) {
                ...
                if (var11 != null && var11.frameIds != null && !var11.isCachedModelIdSet()) {
                    ...
                    if (var0.spotAnimationFrame < var11.frameIds.length
                            && var0.spotAnimFrameCycle > var11.frameLengths[var0.spotAnimationFrame]) {
                    ...
                    if (var0.spotAnimationFrame >= var11.frameIds.length
                            && (var0.spotAnimationFrame < 0 || var0.spotAnimationFrame >= var11.frameIds.length)) {
                        var0.spotAnimation = -1;
                    }
        ...
        if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
            var12 = class85.SequenceDefinition_get(var0.sequence);
            if (var12.precedenceAnimating == 1 && var0.field1006 > 0 && var0.exactMoveArrive1Cycle <= Client.cycle
        ...
        if (var0.sequence != -1 && var0.sequenceDelay == 0) {
            ...
            if (var12 == null) {
                ...
                if (var0.sequenceFrame < var12.frameIds.length
                        && var0.sequenceFrameCycle > var12.frameLengths[var0.sequenceFrame]) {
