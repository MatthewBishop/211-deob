...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
        ...
        if (var0 == 1100) {
            ...
            if (var0 == 1113) {
                ...
                if (var3.type == 12) {
                    var11 = var3.method1750();
                    if (var11 != null) {
                        var11.method1711(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize],
                                Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1]);
                ...
                if (var4 != -1 && var3.type == 0) {
                    AbstractWorldMapData.revalidateWidgetScroll(WorldMapLabel.Widget_interfaceComponents[var4 >> 16],
                            var3, false);
                }
                ...
                if (var0 == 1126) {
                    ...
                    var3.method1736(Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize],
                            class245.urlRequester, class17.method64());
                    return 1;
                } else if (var0 == 1131) {
                    class302.Interpreter_intStackSize -= 2;
                    var3.method1737(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize],
                            Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1]);
                    return 1;
                } else if (var0 == 1132) {
                    var3.method1738(Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize],
                    ...
                    if (var0 == 1133) {
                        ...
                        var11 = var3.method1750();
                        if (var11 != null && var11
                                .method1646(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize])) {
                            LoginScreenAnimation.invalidateWidget(var3);
                        }
                        ...
                        var11 = var3.method1750();
                        if (var11 != null && var11
                                .method1647(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize])) {
                            LoginScreenAnimation.invalidateWidget(var3);
                        }
                        ...
                        var11 = var3.method1750();
                        if (var11 != null && var11
                                .method1717(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize])) {
                            LoginScreenAnimation.invalidateWidget(var3);
                        }
                        ...
                        if (var0 == 1140) {
                            ...
                            class302.Interpreter_intStackSize -= 2;
                            var11 = var3.method1750();
                            if (var11 != null && var11.method1700(
                                    Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize],
                                    Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1])) {
                                LoginScreenAnimation.invalidateWidget(var3);
                            }
                            ...
                            if (var0 == 1148) {
                                ...
                                if (var8 != null) {
                                    var8.method97(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize],
                                            Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1]);
                                }
                                ...
                                if (var8 != null) {
                                    var8.method106(
                                            (char) Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize],
                                            Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1]);
                                }
            ...
            if (var0 == 1301) {
                ...
                if (var0 != 1350) {
                    ...
                    if (var0 == 1351) {
                        ...
                        var5 = 10;
                        var9 = new byte[] {
                                (byte) Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize] };
                        byte[] var10 = new byte[] {
                                (byte) Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1] };
                    ...
                    if (var3) {
                        ...
                        for (var7 = 0; var7 < 10 && Interpreter.Interpreter_intStack[var7
                                + class302.Interpreter_intStackSize] >= 0; var7 += 2) {
                            ;
                        }
                        ...
                        if (var7 > 0) {
                            ...
                            for (var7 -= 2; var7 >= 0; var7 -= 2) {
                                ...
                                var9[var7 / 2] = (byte) Interpreter.Interpreter_intStack[var7
                                        + class302.Interpreter_intStackSize + 1];
                            }
                        }
                    } else {
                        class302.Interpreter_intStackSize -= 2;
    ...
    static void method341() {
        if (Client.oculusOrbOnLocalPlayer && class387.localPlayer != null) {
            ...
            int var2 = GrandExchangeOfferNameComparator.getTileHeight(class387.localPlayer.x, class387.localPlayer.y,
                    class103.Client_plane) - Client.camFollowHeight;
