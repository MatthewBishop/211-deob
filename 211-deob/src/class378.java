public class class378 {
    ...
    public String toString() {
        ...
        return "    Size: " + this.field3634 + var5 + "Created: " + this.field3630 + var7 + "Total used: "
                + this.field3631 + var6 + "Max-In-Use: " + this.field3633;
    }
                        ...
                        if (var0 == 6513) {
                            ...
                            if (var9.isString()) {
                                Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
                                        - 1] = class137.getNpcDefinition(var7).getStringParam(var8, var9.defaultStr);
                            } else {
                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class137
                            ...
                            if (var9.isString()) {
                                Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
                                        - 1] = class463.getObjectDefinition(var7).getStringParam(var8, var9.defaultStr);
                            } else {
                            ...
                            if (var9.isString()) {
                                Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
                                        - 1] = TileItem.ItemDefinition_get(var7).getStringParam(var8, var9.defaultStr);
                            } else {
                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = TileItem
                                        .ItemDefinition_get(var7).getIntParam(var8, var9.defaultInt);
                            }
                            ...
                            var9 = ClanChannelMember.getParamDefinition(var8);
                            if (var9.isString()) {
                                Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = Actor
                                        .StructDefinition_getStructDefinition(var7)
                                        .getStringParam(var8, var9.defaultStr);
                            } else {
                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Actor
                                        .StructDefinition_getStructDefinition(var7).getIntParam(var8, var9.defaultInt);
                            }

                            return 1;
                        } else if (var0 == 6518) {
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Client.onMobile
                                    ? 1
                                    : 0;
                            return 1;
                        } else if (var0 == 6519) {
