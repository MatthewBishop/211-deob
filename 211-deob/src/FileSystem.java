                ...
                if (var2 == 14) {
                    ...
                    if (var2 == 24) {
                        ...
                        if (var17 != null) {
                            ...
                            if (var12) {
                                var11 = Renderable.getPacketBufferNode(ClientPacket.field2531,
                        ...
                        if (var2 == 25) {
                            ...
                            if (var17 != null) {
                                ...
                                ClanChannel.selectSpell(var1, var0,
                                        MenuAction.Widget_unpackTargetMask(class173.getWidgetFlags(var17)), var4);
                                ...
                                if (var17.isIf3) {
                                    ...
                                    Client.selectedSpellName = class149.colorStartTag(65280) + var17.spellName
                                            + class149.colorStartTag(16777215);
                                }
                            }
                        ...
                        if (var2 == 26) {
                            ...
                            Widget var15;
                            if (var2 == 28) {
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2531,
                                        Client.packetWriter.isaacCipher);
                                var9.packetBuffer.writeInt(var1);
                                Client.packetWriter.addNode(var9);
                                var15 = class133.getWidget(var1);
                                if (var15 != null && var15.cs1Instructions != null
                                        && var15.cs1Instructions[0][0] == 5) {
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2456,
                                        Client.packetWriter.isaacCipher);
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2448,
                                        Client.packetWriter.isaacCipher);
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2506,
                                        Client.packetWriter.isaacCipher);
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2520,
                                        Client.packetWriter.isaacCipher);
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2462,
                                        Client.packetWriter.isaacCipher);
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2530,
                                        Client.packetWriter.isaacCipher);
                                var9.packetBuffer.method2414(var1);
                                var9.packetBuffer.writeShortA(var0);
                                ...
                                var9 = Renderable.getPacketBufferNode(ClientPacket.field2505,
                                        Client.packetWriter.isaacCipher);
                                var9.packetBuffer.writeShort(var0);
                                var9.packetBuffer.writeInt(var1);
                                var9.packetBuffer.writeShortA(var4);
                                ...
                                if (var2 == 38) {
                                    ...
                                    Client.selectedItemName = class149.colorStartTag(16748608)
                                            + TileItem.ItemDefinition_get(var4).name + class149.colorStartTag(16777215);
                                ...
                                if (var2 == 39) {
                                    var9 = Renderable.getPacketBufferNode(ClientPacket.field2474,
                                            Client.packetWriter.isaacCipher);
                                    ...
                                    var9 = Renderable.getPacketBufferNode(ClientPacket.field2510,
                                            Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.writeShortLE(var0);
                                    var9.packetBuffer.writeShortLE(var4);
                                    ...
                                    var9 = Renderable.getPacketBufferNode(ClientPacket.field2467,
                                            Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.method2441(var1);
                                    var9.packetBuffer.writeShort(var4);
                                    var9.packetBuffer.writeShort(var0);
                                    ...
                                    var9 = Renderable.getPacketBufferNode(ClientPacket.field2493,
                                            Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.writeShort(var4);
                                    var9.packetBuffer.writeShortA(var0);
                                    var9.packetBuffer.method2382(var1);
                                    ...
                                    var9 = Renderable.getPacketBufferNode(ClientPacket.field2473,
                                            Client.packetWriter.isaacCipher);
                                    var9.packetBuffer.writeShortLEA(var4);
                                    var9.packetBuffer.writeShortA(var0);
                                    var9.packetBuffer.writeInt(var1);
                                    ...
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2450,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer.writeShortLEA(var3);
                                        var10.packetBuffer
                                                .writeByteA(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        Client.packetWriter.addNode(var10);
                                    }
                                } else if (var2 == 45) {
                                    var16 = Client.players[var3];
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2521,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer.writeShortLE(var3);
                                        var10.packetBuffer
                                                .writeByte(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        Client.packetWriter.addNode(var10);
                                    }
                                } else if (var2 == 46) {
                                    var16 = Client.players[var3];
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2525,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer
                                                .writeByte(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        var10.packetBuffer.writeShortLE(var3);
                                    ...
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2517,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer.writeShort(var3);
                                        var10.packetBuffer
                                                .writeByteS(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        Client.packetWriter.addNode(var10);
                                    }
                                } else if (var2 == 48) {
                                    var16 = Client.players[var3];
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2479,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer
                                                .method2399(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        var10.packetBuffer.writeShortA(var3);
                                        Client.packetWriter.addNode(var10);
                                    }
                                } else if (var2 == 49) {
                                    ...
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2478,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer
                                                .writeByteS(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        var10.packetBuffer.writeShort(var3);
                                    ...
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2438,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer.writeShortLEA(var3);
                                        var10.packetBuffer
                                                .method2399(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                    ...
                                    if (var16 != null) {
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var10 = Renderable.getPacketBufferNode(ClientPacket.field2440,
                                                Client.packetWriter.isaacCipher);
                                        var10.packetBuffer
                                                .writeByte(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
                                        var10.packetBuffer.writeShortLE(var3);
                                    ...
                                    if (var2 == 58) {
                                        ...
                                        if (var17 != null) {
                                            ...
                                            var10 = Renderable.getPacketBufferNode(ClientPacket.field2497,
                                                    Client.packetWriter.isaacCipher);
                                        ...
                                        Client.destinationX = var0;
                                        Client.destinationY = var1;
                                        var9 = Renderable.getPacketBufferNode(ClientPacket.field2535,
                                                Client.packetWriter.isaacCipher);
                                        var9.packetBuffer.writeShortA(Client.baseY + var1);
                                        var9.packetBuffer.writeShortA(var0 + ParamComposition.baseX);
                                        var9.packetBuffer.writeShortLE(var3);
                                        ...
                                        Client.mouseCrossColor = 2;
                                        Client.mouseCrossState = 0;
                                        var9 = Renderable.getPacketBufferNode(ClientPacket.field2429,
                                                Client.packetWriter.isaacCipher);
                                        var9.packetBuffer.writeShortLEA(var3);
                                        Client.packetWriter.addNode(var9);
                                    } else if (var2 == 1003) {
                                        ...
                                        if (var14 != null) {
                                            ...
                                            if (var19 != null) {
                                                var11 = Renderable.getPacketBufferNode(ClientPacket.field2449,
                                                        Client.packetWriter.isaacCipher);
                                        ...
                                        Client.mouseCrossColor = 2;
                                        Client.mouseCrossState = 0;
                                        var9 = Renderable.getPacketBufferNode(ClientPacket.field2529,
                                                Client.packetWriter.isaacCipher);
                                        var9.packetBuffer.writeShortA(var3);
                                        var9.packetBuffer.writeShort(var0 + ParamComposition.baseX);
                                        var9.packetBuffer.writeShortA(Client.baseY + var1);
                                        ...
                                        if (var17 != null && var17.itemQuantities[var0] >= 100000) {
                                            ZoneOperation.addGameMessage(27, "", var17.itemQuantities[var0] + " x "
                                                    + TileItem.ItemDefinition_get(var4).name);
                                        } else {
                                            var10 = Renderable.getPacketBufferNode(ClientPacket.field2460,
                                                    Client.packetWriter.isaacCipher);
                                        ...
                                        class378.field3629 = class133.getWidget(var1);
                                        Client.field487 = var0;
                                    } else if (var2 == 1009 || var2 == 1011 || var2 == 1010 || var2 == 1008
                                            || var2 == 1012) {
                                        GrandExchangeOfferUnitPriceComparator.worldMap.worldMapMenuAction(var2, var3,
                                                new Coord(var0), new Coord(var1));
                                    }
                                } else {
                                    var17 = class135.getWidgetChild(var1, var0);
                                    if (var17 != null) {
