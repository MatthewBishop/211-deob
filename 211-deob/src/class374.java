        ...
        if (var0 != null && var0.isVisible()) {
            ...
            if (var0.overheadText != null && (!var8 || !var0.showPublicPlayerChat && (Client.publicChatMode == 4
                ...
                if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) {
                    Client.overheadTextXOffsets[Client.overheadTextCount] = class19.fontBold12
                    ...
                    if (var11 == null) {
                        ...
                        if (var13 != null && var14 != null) {
                            ...
                            if (Client.viewportTempX > -1) {
                                ...
                                Rasterizer2D.Rasterizer2D_fillRectangle(var99 + var21, var22, var15 - var99, 5,
                                        16711680);
                            }
            ...
            if (var8 && var0.playerCycle == Client.cycle) {
                ...
                if (var76) {
                    ...
                    if (var8) {
                        ...
                        var9 += 4;
                        var96.drawCentered(var94.username.getName(), var2 + Client.viewportTempX,
            ...
            if (var8) {
                ...
                if (var90.headIconPk != -1 || var90.headIconPrayer != -1) {
                    ...
                    if (Client.viewportTempX > -1) {
                        if (var90.headIconPk != -1) {
                            var9 += 25;
                            ClanChannel.headIconPkSprites[var90.headIconPk].drawTransBgAt(
                                    var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var9);
                        }

                        if (var90.headIconPrayer != -1) {
                            var9 += 25;
                            class367.headIconPrayerSprites[var90.headIconPrayer].drawTransBgAt(
                                    var2 + Client.viewportTempX - 12, var3 + Client.viewportTempY - var9);
                        }
                    }
                }
                ...
                if (var1 >= 0 && Client.hintArrowType == 10 && var7[var1] == Client.hintArrowPlayerIndex) {
                    ...
                    if (Client.viewportTempX > -1) {
                        ...
                        WorldMapSectionType.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12,
                    ...
                    for (int var103 = 0; var103 < var95.length; ++var103) {
                        if (var95[var103] >= 0 && var93[var103] >= 0) {
                            ...
                            if (var82 != null) {
                                class31.method121(var0, var0.defaultHeight + 15);
                                if (Client.viewportTempX > -1) {
                                    var82.drawTransBgAt(var2 + Client.viewportTempX - (var82.subWidth >> 1),
                                            Client.viewportTempY + (var3 - var82.subHeight) - 4);
                                }
                            }
                        }
                    }
                ...
                if (Client.hintArrowType == 1 && Client.npcIndices[var1 - var75] == Client.hintArrowNpcIndex
                    ...
                    class31.method121(var0, var0.defaultHeight + 15);
                    if (Client.viewportTempX > -1) {
                        WorldMapSectionType.headIconHintSprites[0].drawTransBgAt(var2 + Client.viewportTempX - 12,
