                    ...
                    for (int var15 = 0; var15 < 100; ++var15) {
                        ...
                        if (var5 > 0) {
                            ...
                            if (WorldMapDecoration.NetCache_currentResponse == null) {
                                ...
                                NetFileRequest var13 = (NetFileRequest) NetCache.NetCache_pendingPriorityResponses
                                        .get(var11);
                                ...
                                class14.NetCache_responseArchiveBuffer = new Buffer(
                                        var14 + var10 + WorldMapDecoration.NetCache_currentResponse.padding);
                            ...
                            var6 = class14.NetCache_responseArchiveBuffer.array.length
                            ...
                            NetCache.NetCache_socket.read(class14.NetCache_responseArchiveBuffer.array,
                                    class14.NetCache_responseArchiveBuffer.offset, var7);
                            if (NetCache.field3482 != 0) {
                                for (var8 = 0; var8 < var7; ++var8) {
                                    class14.NetCache_responseArchiveBuffer.array[var8
                                            + class14.NetCache_responseArchiveBuffer.offset] ^= NetCache.field3482;
                                }
                            }
                            ...
                            if (var6 == class14.NetCache_responseArchiveBuffer.offset) {
                                if (16711935L == WorldMapDecoration.NetCache_currentResponse.key) {
                                    ...
                                    WorldMapDecoration.NetCache_currentResponse.archive.write(
                                            (int) (WorldMapDecoration.NetCache_currentResponse.key & 65535L),
                                            class14.NetCache_responseArchiveBuffer.array,
                                            16711680L == (WorldMapDecoration.NetCache_currentResponse.key & 16711680L),
                                            Messages.field1118);
                                }
