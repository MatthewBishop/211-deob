public enum class85 implements class349 {
    ...
    static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6,
        ...
        for (int var8 = 0; var8 < var0.length; ++var8) {
            ...
            if (var9 != null && var9.parentId == var1 && (var9.method1734() || class173.getWidgetFlags(var9) != 0
                    || var9 == Client.clickedWidgetParent)) {
                if (var9.isIf3) {
                    if (class160.isComponentHidden(var9)) {
                        continue;
                    }
                } else if (var9.type == 0 && var9 != KeyHandler.mousedOverWidgetIf1
                        && class160.isComponentHidden(var9)) {
                    continue;
                }
                ...
                if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
                    ...
                    if (var9.contentType == 1337) {
                        ...
                        if (var9.contentType == 1400) {
                            GrandExchangeOfferUnitPriceComparator.worldMap.onCycle(MouseHandler.MouseHandler_x,
                                    MouseHandler.MouseHandler_y, var35, var26, var11, var9.width, var9.height);
                        }

                        if (!Client.isMenuOpen && var35) {
                            if (var9.contentType == 1400) {
                                GrandExchangeOfferUnitPriceComparator.worldMap.addElementMenuOptions(var26, var11,
                                        var9.width, var9.height, var17, var18);
                            } else {
                        ...
                        if (var34) {
                            for (int var20 = 0; var20 < var9.field2937.length; ++var20) {
                                    ...
                                    for (var23 = 0; var23 < var9.field2937[var20].length; ++var23) {
                                        ...
                                        if (var9.field2900 != null) {
                                            var24 = Client.keyHandlerInstance
                                                    .getKeyPressed(var9.field2937[var20][var23]);
                                        }
                                ...
                                if (var22) {
                                    if (var20 < 10) {
                                        class16.widgetDefaultMenuAction(var20 + 1, var9.id, var9.childIndex,
                                                var9.itemId, "");
                                    } else if (var20 == 10) {
                                        class18.Widget_runOnTargetLeave();
                                        ClanChannel.selectSpell(var9.id, var9.childIndex,
                                                MenuAction.Widget_unpackTargetMask(class173.getWidgetFlags(var9)),
                                                var9.itemId);
                        ...
                        if (var9.isIf3) {
                            ...
                            if ((MouseHandler.MouseHandler_currentButton == 1
                                    || !ClanMate.mouseCam && MouseHandler.MouseHandler_currentButton == 4) && var35) {
                                var36 = true;
                            }
                            ...
                            if (var21) {
                                UserComparator9.clickWidget(var9, MouseHandler.MouseHandler_lastPressedX - var26,
                                        MouseHandler.MouseHandler_lastPressedY - var11);
                            }

                            if (var9.method1735()) {
                                if (var21) {
                                    Client.field587.addFirst(new class204(0, MouseHandler.MouseHandler_x - var26,
                                            MouseHandler.MouseHandler_y - var11, var9));
                                }

                                if (var36) {
                                    Client.field587.addFirst(new class204(1, MouseHandler.MouseHandler_x - var26,
                                            MouseHandler.MouseHandler_y - var11, var9));
                                }
                            }

                            if (var9.contentType == 1400) {
                                GrandExchangeOfferUnitPriceComparator.worldMap.method2235(var17, var18, var35 & var36,
                                        var35 & var21);
                            }

                            if (Client.clickedWidget != null && var9 != Client.clickedWidget && var35
                                    && AbstractArchive.method1837(class173.getWidgetFlags(var9))) {
                            ...
                            if (var9.hasListener) {
                                ...
                                if (Client.clickedWidget != null || WorldMapLabelSize.dragInventoryWidget != null
                                        || Client.isMenuOpen) {
                                    var21 = false;
                                    var36 = false;
                                    var35 = false;
                                ...
                                if (var9.onVarTransmit != null && Client.changedVarpCount > var9.field3001) {
                                    if (var9.varTransmitTriggers != null
                                            && Client.changedVarpCount - var9.field3001 <= 32) {
                                        label654: for (var37 = var9.field3001; var37 < Client.changedVarpCount; ++var37) {
                                ...
                                if (var9.onInvTransmit != null && Client.changedItemContainersCount > var9.field3002) {
                                    if (var9.invTransmitTriggers != null
                                            && Client.changedItemContainersCount - var9.field3002 <= 32) {
                                        label630: for (var37 = var9.field3002; var37 < Client.changedItemContainersCount; ++var37) {
                                ...
                                if (var9.onStatTransmit != null && Client.changedSkillsCount > var9.field3003) {
                                    if (var9.statTransmitTriggers != null
                                            && Client.changedSkillsCount - var9.field3003 <= 32) {
                                        label606: for (var37 = var9.field3003; var37 < Client.changedSkillsCount; ++var37) {
                        ...
                        if (!var9.isIf3) {
                            ...
                            if (var9.scrollHeight > var9.height) {
                                World.method382(var9, var26 + var9.width, var11, var9.height, var9.scrollHeight,
