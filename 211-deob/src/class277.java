        ...
        if (var0.length == 100 && ByteArrayPool.ByteArrayPool_smallCount < ByteArrayPool.field3640) {
            ...
            if (class9.ByteArrayPool_arrays != null) {
                for (int var1 = 0; var1 < class172.ByteArrayPool_alternativeSizes.length; ++var1) {
                    if (var0.length == class172.ByteArrayPool_alternativeSizes[var1]
                            && class132.ByteArrayPool_altSizeArrayCounts[var1] < class9.ByteArrayPool_arrays[var1].length) {
                    ...
                    for (var8 = 0; var8 < 13; ++var8) {
                        ...
                        if (var9 != -1) {
                            ...
                            if (var12 != -1) {
                                ...
                                var13 = var12 >> 8 & 255;
                                int var14 = var12 & 255;
                                Renderable.regionMapArchiveIds[var5] = NetCache.archive9
                                        .getGroupId("m" + var13 + "_" + var14);
                                class217.regionLandArchiveIds[var5] = NetCache.archive9
