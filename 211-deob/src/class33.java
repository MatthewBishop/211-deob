public class class33 {
    ...
    static PrivateChatMode[] method134() {
        return new PrivateChatMode[] { PrivateChatMode.field4119, PrivateChatMode.field4117,
                PrivateChatMode.field4118 };
    }
    ...
    public static Font method129(AbstractArchive var0, AbstractArchive var1, int var2, int var3) {
        if (!Buffer.method2444(var0, var2, var3)) {
            ...
            if (var5 == null) {
                ...
                Font var6 = new Font(var5, class488.SpriteBuffer_xOffsets,
                        ApproximateRouteStrategy.SpriteBuffer_yOffsets, FriendsList.SpriteBuffer_spriteWidths,
                        class132.SpriteBuffer_spriteHeights, class100.SpriteBuffer_spritePalette,
                        class140.SpriteBuffer_pixels);
                class100.method595();
                var4 = var6;
            }
    ...
    static void getLoginError(int var0) {
        ...
        if (var0 == -3) {
            ...
            Login.field752 = 2;
            class70.setLoginResponseString("Either your account is still logged in, or the last",
            ...
            if (var0 == 7) {
                ...
                class70.setLoginResponseString("We suspect someone knows your password.",
                        "Press 'change your password' on front page.", "");
            } else if (var0 == 12) {
                class70.setLoginResponseString("You need a members account to login to this world.",
                ...
                class70.setLoginResponseString("Too many login attempts.",
                        "Please wait a few minutes before trying again.", "");
            } else if (var0 == 17) {
                class70.setLoginResponseString("To access this free world, log into a",
                        "members world and move your character", "to a non-members area.");
            } else if (var0 == 18) {
                ReflectionCheck.method171(14);
                Login.field751 = 1;
            } else if (var0 == 19) {
                class70.setLoginResponseString("This world is running a closed Beta.", "Sorry invited players only.",
                ...
                class70.setLoginResponseString("Unexpected loginserver response.",
                        "Please try using a different world.", "");
            } else if (var0 == 26) {
                class70.setLoginResponseString("This computers address has been blocked",
                        "as it was used to break our rules.", "");
            } else if (var0 == 27) {
                class70.setLoginResponseString("", "Service unavailable.", "");
            } else if (var0 == 31) {
                class70.setLoginResponseString("Your account must have a displayname set",
                        "in order to play the game.  Please set it", "via the website, or the main game.");
            } else if (var0 == 32) {
                ReflectionCheck.method171(14);
                Login.field751 = 2;
            } else if (var0 == 37) {
                class70.setLoginResponseString("Your account is currently inaccessible.",
                        "Please try again in a few minutes.", "");
            } else if (var0 == 38) {
                class70.setLoginResponseString("You need to vote to play!", "Visit runescape.com and vote,",
                ...
                if (var0 == 61) {
                    ...
                    if (var0 == 71) {
                        class246.updateGameState(10);
                        ReflectionCheck.method171(7);
                        class70.setLoginResponseString("There was a problem updating your DOB.",
                                "Please try again later. If the problem ", "persists, please contact Jagex Support.");
                    } else if (var0 == 73) {
                        class246.updateGameState(10);
                        ReflectionCheck.method171(6);
                        class70.setLoginResponseString("Your date of birth information is waiting",
                                "to be reviewed by our staff.", "It will be processed shortly.");
                    } else if (var0 == 72) {
                        class246.updateGameState(10);
                        ReflectionCheck.method171(26);
                    } else {
                        class70.setLoginResponseString("Unexpected server response",
                                "Please try using a different world.", "");
                    }
                }
            }
