public class WorldMapArchiveLoader {
    ...
    int load() {
        ...
        if (this.percentLoaded == 33) {
            if (this.archive.isValidFileName(WorldMapCacheName.field2394.name, this.cacheName)
                    && !this.archive.tryLoadFileByNames(WorldMapCacheName.field2394.name, this.cacheName)) {
                return this.percentLoaded;
            }
