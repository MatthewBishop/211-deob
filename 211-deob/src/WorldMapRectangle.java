    ...
    static int method1452(int var0, Script var1, boolean var2) {
        ...
        if (var0 == 6600) {
            ...
            if (var0 == 6601) {
                ...
                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = WorldMapDecorationType
                        .getWorldMap().getZoomLevel();
                return 1;
            } else if (var0 == 6604) {
                var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                ...
                if (var0 == 6606) {
                    ...
                    if (var0 == 6611) {
                        ...
                        if (var13 == null) {
                            ...
                            Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var13
                                    .getOrigin().packed();
                        }
                        ...
                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                - 1] = WorldMapDecorationType.getWorldMap().currentMapAreaId();
                        return 1;
                    } else if (var0 == 6617) {
                        var15 = new Coord(Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                        ...
                        if (var0 == 6618) {
                            ...
                            if (var13 == null) {
                                ...
                                if (var7 == null) {
                                    ...
                                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var7
                                            .packed();
                                }
                            ...
                            if (var0 == 6619) {
                                ...
                                if (var11 == null) {
                                    ...
                                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var11
                                            .containsCoord(var12.plane, var12.x, var12.y) ? 1 : 0;
                                    return 1;
                                }
                            } else if (var0 == 6622) {
                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                        - 1] = WorldMapDecorationType.getWorldMap().getDisplayWith();
                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                        - 1] = WorldMapDecorationType.getWorldMap().getDisplayHeight();
                                return 1;
                            } else if (var0 == 6623) {
                                var15 = new Coord(
                                        Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                                var13 = WorldMapDecorationType.getWorldMap().mapAreaAtCoord(var15.plane, var15.x,
                                        var15.y);
                                if (var13 == null) {
                                    Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = -1;
                                } else {
                                ...
                                WorldMapDecorationType.getWorldMap().setMaxFlashCount(
                                        Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                                return 1;
                            } else if (var0 == 6625) {
                                ...
                                WorldMapDecorationType.getWorldMap().setCyclesPerFlash(
                                        Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize]);
                                return 1;
                            } else if (var0 == 6627) {
                                ...
                                if (var0 == 6628) {
                                    ...
                                    if (var0 == 6633) {
                                        ...
                                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                - 1] = WorldMapDecorationType.getWorldMap().getElementsDisabled() ? 1
                                                        : 0;
                                        return 1;
                                    } else if (var0 == 6636) {
                                        var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                - 1] = WorldMapDecorationType.getWorldMap().isElementDisabled(var3) ? 1
                                                        : 0;
                                        return 1;
                                    } else if (var0 == 6637) {
                                        var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
                                        Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                - 1] = WorldMapDecorationType.getWorldMap().isCategoryDisabled(var3) ? 1
                                                        : 0;
                                        return 1;
                                    } else if (var0 == 6638) {
                                        class302.Interpreter_intStackSize -= 2;
                                        ...
                                        if (var0 == 6639) {
                                            ...
                                            if (var0 == 6693) {
                                                ...
                                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                        - 1] = class20.worldMapEvent.mapElement;
                                                return 1;
                                            } else if (var0 == 6698) {
                                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                        - 1] = class20.worldMapEvent.coord1.packed();
                                                return 1;
                                            } else if (var0 == 6699) {
                                                Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
                                                        - 1] = class20.worldMapEvent.coord2.packed();
                                                return 1;
                                            } else {
                                                return 2;
                                            }
