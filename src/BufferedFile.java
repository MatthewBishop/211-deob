		...
		try {
			...
			if (this.writeBufferOffset != -1L) {
				...
				if ((long) this.writeBufferLength + this.writeBufferOffset > var4
						&& this.writeBufferOffset + (long) this.writeBufferLength <= (long) var7 + var4) {
					var10 = this.writeBufferOffset + (long) this.writeBufferLength;
				} else if (var4 + (long) var7 > this.writeBufferOffset
	...
	public void write(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (-1L != this.writeBufferOffset && (this.offset < this.writeBufferOffset
					|| this.offset > (long) this.writeBufferLength + this.writeBufferOffset)) {
				this.flush();
			}
		...
		if (-1L != this.writeBufferOffset) {
			...
			if (this.writeBufferOffset >= this.readBufferOffset
				...
				var1 = this.writeBufferOffset;
					...
					&& this.readBufferOffset < (long) this.writeBufferLength + this.writeBufferOffset) {
