...
class class12 extends SSLSocket {
	...
	static void method50(int var0, int var1, int var2, int var3) {
		for (ObjectSound var4 = (ObjectSound) ObjectSound.objectSounds
				.last(); var4 != null; var4 = (ObjectSound) ObjectSound.objectSounds.previous()) {
			if (var4.soundEffectId != -1 || var4.soundEffectIds != null) {
				...
				if (var5 - 64 <= var4.field692 && PacketWriter.clientPreferences.getAreaSoundEffectsVolume() != 0
						&& var0 == var4.plane) {
					var5 -= 64;
					if (var5 < 0) {
						var5 = 0;
					...
					int var6 = (var4.field692 - var5) * PacketWriter.clientPreferences.getAreaSoundEffectsVolume()
							/ var4.field692;
					if (var4.stream1 == null) {
						if (var4.soundEffectId >= 0) {
							SoundEffect var7 = SoundEffect.readSoundEffect(DynamicObject.field826, var4.soundEffectId,
									0);
							if (var7 != null) {
					...
					if (var4.stream2 == null) {
						if (var4.soundEffectIds != null && (var4.field697 -= var3) <= 0) {
							...
							SoundEffect var12 = SoundEffect.readSoundEffect(DynamicObject.field826,
									var4.soundEffectIds[var11], 0);
							if (var12 != null) {
								...
								var4.stream2 = var10;
								var4.field697 = var4.field699
										+ (int) (Math.random() * (double) (var4.field695 - var4.field699));
							}
						}
					} else {
