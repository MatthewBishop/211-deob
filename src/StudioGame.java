...
public enum StudioGame implements class349 {
	...
	static int method1785(int var0, Script var1, boolean var2) {
		if (var0 == 5000) {
			...
			class288.privateChatMode = NewShit
					.method955(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1]);
			...
			PacketBufferNode var11 = Renderable.getPacketBufferNode(ClientPacket.field2436,
			...
			if (var0 == 5002) {
				...
				if (var0 == 5003) {
					...
					if (var8 != null) {
						...
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var8.isFromFriend()
								? 1
								: (var8.isFromIgnored() ? 2 : 0);
					} else {
					...
					if (var0 == 5004) {
						...
						if (var9 != null) {
							...
							Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var9
						...
						if (var0 == 5008) {
							...
							var12 = Renderable.getPacketBufferNode(ClientPacket.field2443,
									Client.packetWriter.isaacCipher);
							...
							if (var0 == 5016) {
								...
								var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Projectile
										.Messages_getHistorySize(var7);
								return 1;
							} else if (var0 == 5018) {
								var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class7
										.Messages_getLastChatID(var7);
								return 1;
							} else if (var0 == 5019) {
								var7 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
										- 1] = WorldMapSection1.method1465(var7);
								return 1;
							} else if (var0 == 5020) {
								var3 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
								...
								Client.field604 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize]
										.toLowerCase().trim();
								return 1;
							} else if (var0 == 5022) {
								Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
								...
								if (var8 != null) {
									...
									Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
											- 1] = var8.text != null ? var8.text : "";
									Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var8
