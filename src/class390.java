		...
		if (var0 == 3600) {
			if (WorldMapElement.friendSystem.field682 == 0) {
				...
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapElement.friendSystem.friendsList.getSize();
			}
			...
			if (var0 == 3601) {
				...
				if (WorldMapElement.friendSystem.method404() && var3 >= 0
						&& var3 < WorldMapElement.friendSystem.friendsList.getSize()) {
				...
				if (WorldMapElement.friendSystem.method404() && var3 >= 0
						&& var3 < WorldMapElement.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = ((Buddy) WorldMapElement.friendSystem.friendsList.get(var3)).world;
				} else {
				...
				if (WorldMapElement.friendSystem.method404() && var3 >= 0
						&& var3 < WorldMapElement.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = ((Buddy) WorldMapElement.friendSystem.friendsList.get(var3)).rank;
				} else {
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
				}
				...
				if (var0 == 3604) {
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = WorldMapElement.friendSystem
									.isFriended(new Username(var5, WorldMapCacheName.loginType), false) ? 1 : 0;
					return 1;
				} else if (var0 == 3611) {
					if (class463.friendsChat != null) {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
								- 1] = class463.friendsChat.name;
					} else {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class463.friendsChat != null) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class463.friendsChat
								.getSize();
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class463.friendsChat != null && var3 < class463.friendsChat.getSize()) {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
								- 1] = class463.friendsChat.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (class463.friendsChat != null && var3 < class463.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = ((Buddy) class463.friendsChat.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (class463.friendsChat != null && var3 < class463.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = ((Buddy) class463.friendsChat.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = class463.friendsChat != null ? class463.friendsChat.minKick : 0;
					return 1;
				} else if (var0 == 3617) {
					var5 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = class463.friendsChat != null ? class463.friendsChat.rank * -414265771 * -2029011203
									: 0;
					return 1;
				} else if (var0 == 3619) {
					var5 = Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize];
					...
					if (!WorldMapElement.friendSystem.method404()) {
						...
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = WorldMapElement.friendSystem.ignoreList.getSize();
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (WorldMapElement.friendSystem.method404() && var3 >= 0
							&& var3 < WorldMapElement.friendSystem.ignoreList.getSize()) {
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = WorldMapElement.friendSystem
									.isIgnored(new Username(var5, WorldMapCacheName.loginType)) ? 1 : 0;
					return 1;
				} else if (var0 == 3624) {
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChat != null && var3 < class463.friendsChat.getSize()
							&& class463.friendsChat.get(var3).getUsername().equals(class387.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChat != null && var3 < class463.friendsChat.getSize()
							&& ((ClanMate) class463.friendsChat.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					if (class463.friendsChat != null && var3 < class463.friendsChat.getSize()
							&& ((ClanMate) class463.friendsChat.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.isCachedModelIdSet()) {
								for (var3.modelFrameCycle += Client.field442; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; LoginScreenAnimation
