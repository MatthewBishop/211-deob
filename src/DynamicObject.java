		...
		if (var0 == 3800) {
			...
			if (var0 == 3801) {
				...
				Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
						- 1] = WorldMapArea.field2264.name;
				return 1;
			} else if (var0 == 3803) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.allowGuests ? 1 : 0;
				return 1;
			} else if (var0 == 3804) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.field1347;
				return 1;
			} else if (var0 == 3805) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.field1363;
				return 1;
			} else if (var0 == 3806) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.field1359;
				return 1;
			} else if (var0 == 3807) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.field1349;
				return 1;
			} else if (var0 == 3809) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.memberCount;
				return 1;
			} else if (var0 == 3810) {
				var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
				Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
						- 1] = WorldMapArea.field2264.memberNames[var3];
				return 1;
			} else if (var0 == 3811) {
				var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.memberRanks[var3];
				return 1;
			} else if (var0 == 3812) {
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
						- 1] = WorldMapArea.field2264.bannedMemberCount;
				return 1;
			} else if (var0 == 3813) {
				var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
				Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
						- 1] = WorldMapArea.field2264.bannedMemberNames[var3];
				return 1;
			} else {
				int var5;
				int var6;
				if (var0 == 3814) {
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = WorldMapArea.field2264
							.method790(var3, var6, var5);
					return 1;
				} else if (var0 == 3815) {
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = WorldMapArea.field2264.currentOwner;
					return 1;
				} else if (var0 == 3816) {
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = WorldMapArea.field2264.field1358;
					return 1;
				} else if (var0 == 3817) {
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = WorldMapArea.field2264
							.method808(Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize]);
					return 1;
				} else if (var0 == 3818) {
					Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1] = WorldMapArea.field2264
							.getSortedMembers()[Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize
									- 1]];
					return 1;
				} else if (var0 == 3819) {
					...
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
							- 1] = WorldMapArea.field2264.field1355[var3];
					return 1;
				} else {
					if (var0 == 3821) {
						class302.Interpreter_intStackSize -= 3;
					...
					if (var0 == 3822) {
						var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = WorldMapArea.field2264.field1356[var3] ? 1 : 0;
						return 1;
					} else if (var0 == 3850) {
						...
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
								- 1] = ScriptFrame.field347.name;
						return 1;
					} else if (var0 == 3853) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = ScriptFrame.field347.field1397;
						return 1;
					} else if (var0 == 3854) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = ScriptFrame.field347.field1396;
						return 1;
					} else if (var0 == 3855) {
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = ScriptFrame.field347
								.method844();
						return 1;
					} else if (var0 == 3856) {
						var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
						Interpreter.Interpreter_stringStack[++class20.Interpreter_stringStackSize
								- 1] = ((ClanChannelMember) ScriptFrame.field347.members.get(var3)).username.getName();
						return 1;
					} else if (var0 == 3857) {
						var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = ((ClanChannelMember) ScriptFrame.field347.members.get(var3)).rank;
						return 1;
					} else if (var0 == 3858) {
						var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize
								- 1] = ((ClanChannelMember) ScriptFrame.field347.members.get(var3)).world;
						return 1;
					} else if (var0 == 3859) {
						var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
						...
						Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = ScriptFrame.field347
								.method842(Interpreter.Interpreter_stringStack[--class20.Interpreter_stringStackSize]);
						return 1;
					} else if (var0 == 3861) {
						Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1] = ScriptFrame.field347
								.getSortedMembers()[Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize
