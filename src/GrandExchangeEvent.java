			...
			if (var1 >= var6 && var1 < 104 - var6 && var2 >= var6 && var2 < 104 - var6) {
				...
				if (var8 == 1) {
					...
					if (var8 == 2) {
						...
						while (true) {
							...
							if (var35 > 0 && class209.directions[var35 - 1][var36] == 0
									&& (var23[var24 - 1][var25] & 19136782) == 0
									&& (var23[var24 - 1][var25 + 1] & 19136824) == 0) {
							...
							if (var35 < 126 && class209.directions[var35 + 1][var36] == 0
									&& (var23[var24 + 2][var25] & 19136899) == 0
									&& (var23[var24 + 2][var25 + 1] & 19136992) == 0) {
								class209.bufferX[var38] = var15 + 1;
								class209.bufferY[var38] = var16;
								var38 = var38 + 1 & 4095;
							...
							if (var36 > 0 && class209.directions[var35][var36 - 1] == 0
									&& (var23[var24][var25 - 1] & 19136782) == 0
									&& (var23[var24 + 1][var25 - 1] & 19136899) == 0) {
							...
							if (var36 < 126 && class209.directions[var35][var36 + 1] == 0
									&& (var23[var24][var25 + 2] & 19136824) == 0
									&& (var23[var24 + 1][var25 + 2] & 19136992) == 0) {
								class209.bufferX[var38] = var15;
								class209.bufferY[var38] = var16 + 1;
								var38 = var38 + 1 & 4095;
							...
							if (var35 > 0 && var36 > 0 && class209.directions[var35 - 1][var36 - 1] == 0
									&& (var23[var24 - 1][var25] & 19136830) == 0
									&& (var23[var24 - 1][var25 - 1] & 19136782) == 0
									&& (var23[var24][var25 - 1] & 19136911) == 0) {
								class209.bufferX[var38] = var15 - 1;
								class209.bufferY[var38] = var16 - 1;
								var38 = var38 + 1 & 4095;
							...
							if (var35 < 126 && var36 > 0 && class209.directions[var35 + 1][var36 - 1] == 0
									&& (var23[var24 + 1][var25 - 1] & 19136911) == 0
									&& (var23[var24 + 2][var25 - 1] & 19136899) == 0
									&& (var23[var24 + 2][var25] & 19136995) == 0) {
								class209.bufferX[var38] = var15 + 1;
								class209.bufferY[var38] = var16 - 1;
								var38 = var38 + 1 & 4095;
							...
							if (var35 > 0 && var36 < 126 && class209.directions[var35 - 1][var36 + 1] == 0
									&& (var23[var24 - 1][var25 + 1] & 19136830) == 0
									&& (var23[var24 - 1][var25 + 2] & 19136824) == 0
									&& (var23[var24][var25 + 2] & 19137016) == 0) {
								class209.bufferX[var38] = var15 - 1;
								class209.bufferY[var38] = var16 + 1;
								var38 = var38 + 1 & 4095;
							...
							if (var35 < 126 && var36 < 126 && class209.directions[var35 + 1][var36 + 1] == 0
									&& (var23[var24 + 1][var25 + 2] & 19137016) == 0
									&& (var23[var24 + 2][var25 + 2] & 19136992) == 0
									&& (var23[var24 + 2][var25 + 1] & 19136995) == 0) {
								class209.bufferX[var38] = var15 + 1;
								class209.bufferY[var38] = var16 + 1;
								var38 = var38 + 1 & 4095;
							...
							label548: while (true) {
									...
									do {
										do {
											label525: do {
												...
												if (var35 > 0 && class209.directions[var35 - 1][var36] == 0
														&& (var23[var24 - 1][var25] & 19136782) == 0
														&& (var23[var24 - 1][var25 + var8 - 1] & 19136824) == 0) {
													var27 = 1;
												...
												if (var35 < 128 - var8 && class209.directions[var35 + 1][var36] == 0
														&& (var23[var8 + var24][var25] & 19136899) == 0
														&& (var23[var8 + var24][var25 + var8 - 1] & 19136992) == 0) {
													var27 = 1;
												...
												if (var36 > 0 && class209.directions[var35][var36 - 1] == 0
														&& (var23[var24][var25 - 1] & 19136782) == 0
														&& (var23[var24 + var8 - 1][var25 - 1] & 19136899) == 0) {
													var27 = 1;
												...
												if (var36 < 128 - var8 && class209.directions[var35][var36 + 1] == 0
														&& (var23[var24][var8 + var25] & 19136824) == 0
														&& (var23[var24 + var8 - 1][var8 + var25] & 19136992) == 0) {
													var27 = 1;
												...
												if (var35 > 0 && var36 > 0
														&& class209.directions[var35 - 1][var36 - 1] == 0
														&& (var23[var24 - 1][var25 - 1] & 19136782) == 0) {
													var27 = 1;
													...
													while (true) {
														...
														if ((var23[var24 - 1][var27 + (var25 - 1)] & 19136830) != 0
																|| (var23[var27 + (var24 - 1)][var25 - 1]
																		& 19136911) != 0) {
															break;
														}
												...
												if (var35 < 128 - var8 && var36 > 0
														&& class209.directions[var35 + 1][var36 - 1] == 0
														&& (var23[var8 + var24][var25 - 1] & 19136899) == 0) {
													var27 = 1;
													...
													while (true) {
														...
														if ((var23[var8 + var24][var27 + (var25 - 1)] & 19136995) != 0
																|| (var23[var27 + var24][var25 - 1] & 19136911) != 0) {
															break;
														}
												...
												if (var35 > 0 && var36 < 128 - var8
														&& class209.directions[var35 - 1][var36 + 1] == 0
														&& (var23[var24 - 1][var25 + var8] & 19136824) == 0) {
													for (var27 = 1; var27 < var8; ++var27) {
														if ((var23[var24 - 1][var25 + var27] & 19136830) != 0
																|| (var23[var27 + (var24 - 1)][var8 + var25]
																		& 19137016) != 0) {
															continue label525;
														}
													}
								...
								for (var27 = 1; var27 < var8; ++var27) {
									if ((var23[var24 + var27][var8 + var25] & 19137016) != 0
											|| (var23[var8 + var24][var25 + var27] & 19136995) != 0) {
										continue label548;
									}
								}
				...
				label606: {
					...
					if (!var33) {
						...
						for (var25 = var38 - var37; var25 <= var37 + var38; ++var25) {
							for (var26 = var22 - var37; var26 <= var22 + var37; ++var26) {
								...
								if (var27 >= 0 && var28 >= 0 && var27 < 128 && var28 < 128
										&& class209.distances[var27][var28] < 100) {
									int var29 = 0;
									if (var25 < var38) {
										var29 = var38 - var25;
					...
					if (var16 == var4 && var35 == var5) {
						...
						for (var19 = var20 = class209.directions[var16 - var14][var35 - var15]; var16 != var4
								|| var5 != var35; var19 = class209.directions[var16 - var14][var35 - var15]) {
							if (var20 != var19) {
								var20 = var19;
