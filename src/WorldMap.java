...
public class WorldMap {
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) {
			...
			if (var3) {
				...
				List var10 = this.worldMapManager.method1394(this.centerTileX - var8 / 2 - 1,
			...
			if (!this.hasTarget() && (var4 || var3)) {
				...
				if (!var7) {
					...
					if (this.field3892 != -1) {
						...
						this.setWorldMapPosition(this.field3892 - (int) ((float) var8 / this.zoomTarget),
								(int) ((float) var9 / this.zoomTarget) + this.field3893, false);
					}
					break label33;
				}
			}
		...
		if (this.currentMapArea != null) {
			...
			if (this.mouseCoord != null && var3) {
				...
				if (var10 && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
					...
					if (var11) {
						PacketBufferNode var14 = Renderable.getPacketBufferNode(ClientPacket.field2441,
		...
		if (var7 < 100) {
			...
			if (!this.elementsDisabled) {
				...
				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
						var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4,
						this.field3903, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
			}
	...
	void method2245(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (class136.field1293 != null) {
			...
			if (this.method2244(var8, var9, var13, var14, var3, var4)) {
				...
				class136.field1293.method1870(this.minCachedTileX, this.minCachedTileY, this.sprite,
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) {
			...
			List var9 = this.worldMapManager.method1394(this.centerTileX - var7 / 2 - 1,
				...
				do {
					...
					for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) {
						if (var12.menuActions[var14] != null) {
							WorldMapManager.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName,
