...
public abstract class UrlRequester implements Runnable {
	...
	public static AccessFile getPreferencesFile(String var0, String var1, boolean var2) {
		...
		File var5 = new File(UserComparator4.userHomeDirectory,
				"jagex_" + var1 + "_preferences" + var0 + var4 + ".dat");
		AccessFile var6;
		if (!var2 && var5.exists()) {
			try {
	...
	static float method635(class125 var0, float var1) {
		if (var0 != null && var0.method701() != 0) {
			if (var1 < (float) var0.field1208[0].field1173) {
				return var0.field1206 == class123.field1193 ? var0.field1208[0].field1167
						: Messages.method617(var0, var1, true);
			} else if (var1 > (float) var0.field1208[var0.method701() - 1].field1173) {
				return var0.field1223 == class123.field1193 ? var0.field1208[var0.method701() - 1].field1167
						: Messages.method617(var0, var1, false);
				...
				if (var2 == null) {
									...
									if (0.0D != (double) var17) {
										...
										if ((double) var20[0] > 1.0D || var20[1] < -1.0F) {
											...
											if (var20[0] > 1.0F || var20[1] > 1.0F) {
												float var23 = (float) (((double) var20[1] - 2.0D) * (double) var20[1]
														+ (double) ((var20[1] + (var20[0] - 2.0F)) * var20[0]) + 1.0D);
												if (var23 + class121.field1175 > 0.0F) {
													if (class121.field1175 + var20[0] < 1.3333334F) {
														float var24 = var20[0] - 2.0F;
														float var25 = var20[0] - 1.0F;
														float var26 = (float) Math
																.sqrt((double) (var24 * var24 - var25 * 4.0F * var25));
										...
										if (var22 != var20[1]) {
											...
											if ((double) var22 != 1.0D) {
												var16 = (float) ((double) var12 - (1.0D - (double) var20[1])
														* (double) (var12 - var11) / (1.0D - (double) var22));
											}
										}

										var0.field1204 = var5;
										var0.field1211 = var8;
										GrandExchangeOfferOwnWorldComparator.method337(0.0F, var20[0], var20[1], 1.0F,
												var0);
					...
					if (var3) {
						...
						return (float) var2.field1173 != var1 && var2.field1168 != null ? var2.field1168.field1167
								: var2.field1167;
					} else {
	...
	static class123[] method628() {
		return new class123[] { class123.field1193, class123.field1195, class123.field1194, class123.field1197,
				class123.field1196 };
	}
}
