public final class Font extends AbstractFont {
    ...
    final void drawGlyph(byte[] var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var3 + var5 > Rasterizer2D.drawingAreaBottom) {
            var5 -= var3 + var5 - Rasterizer2D.drawingAreaBottom;
        }

        if (var2 < Rasterizer2D.drawRegionX) {
            var11 = Rasterizer2D.drawRegionX - var2;
            var4 -= var11;
            var2 = Rasterizer2D.drawRegionX;
            var10 += var11;
            var7 += var11;
            var9 += var11;
            var8 += var11;
        ...
        if (var2 + var4 > Rasterizer2D.drawingAreaRight) {
            var11 = var2 + var4 - Rasterizer2D.drawingAreaRight;
            var4 -= var11;
            var9 += var11;
            var8 += var11;
        }
    ...
    final void drawGlyphAlpha(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        if (var2 < Rasterizer2D.drawRegionX) {
            var12 = Rasterizer2D.drawRegionX - var2;
            var4 -= var12;
            var2 = Rasterizer2D.drawRegionX;
            var11 += var12;
            var8 += var12;
        ...
        if (var2 + var4 > Rasterizer2D.drawingAreaRight) {
            var12 = var2 + var4 - Rasterizer2D.drawingAreaRight;
            var4 -= var12;
            var10 += var12;
            var9 += var12;
        }
