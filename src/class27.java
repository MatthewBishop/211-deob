...
public class class27 {
    ...
    public static ZoneOperation[] method108() {
        return new ZoneOperation[] { ZoneOperation.field2547, ZoneOperation.field2540, ZoneOperation.field2541,
                ZoneOperation.field2542, ZoneOperation.field2543, ZoneOperation.field2546, ZoneOperation.field2544,
                ZoneOperation.field2539, ZoneOperation.field2551, ZoneOperation.field2548, ZoneOperation.field2549,
                ZoneOperation.field2550, ZoneOperation.field2545 };
    }
            ...
            if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
                ...
                if (!var10.isIf3 || !class160.isComponentHidden(var10)) {
                    ...
                    if (!var10.isIf3 || var15 < var17 && var16 < var18) {
                        if (var10.contentType != 0) {
                            if (var10.contentType == 1336) {
                                if (PacketWriter.clientPreferences.method526()) {
                                    var13 += 15;
                                    MenuAction.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps,
                                            var12 + var10.width, var13, 16776960, -1);
                                    var13 += 15;
                                    ...
                                    MenuAction.fontPlain12.drawRightAligned("Mem:" + var20 + "k", var12 + var10.width,
                                            var13, var21, -1);
                                    var13 += 15;
                                }
                                continue;
                            ...
                            if (var10.contentType == 1400) {
                                GrandExchangeOfferUnitPriceComparator.worldMap.draw(var12, var13, var10.width,
                                        var10.height, Client.cycle);
                            }

                            if (var10.contentType == 1401) {
                                GrandExchangeOfferUnitPriceComparator.worldMap.drawOverview(var12, var13, var10.width,
                                        var10.height);
                            }
                        ...
                        if (var10.type == 0) {
                            if (!var10.isIf3 && class160.isComponentHidden(var10)
                                    && var10 != KeyHandler.mousedOverWidgetIf1) {
                                continue;
                            }
                        ...
                        if (Client.isResizable || Client.field428[var11] || Client.gameDrawingMode > 1) {
                            if (var10.type == 0 && !var10.isIf3 && var10.scrollHeight > var10.height) {
                                ParamComposition.drawScrollBar(var12 + var10.width, var13, var10.scrollY, var10.height,
                                        var10.scrollHeight);
                            }
                                ...
                                if (var10.type == 2) {
                                        ...
                                        for (var21 = 0; var21 < var10.rawWidth; ++var21) {
                                            ...
                                            if (var10.itemIds[var19] <= 0) {
                                                ...
                                                if (var22 + 32 > var2 && var22 < var4 && var23 + 32 > var3
                                                        && var23 < var5
                                                        || var10 == WorldMapLabelSize.dragInventoryWidget
                                                                && var19 == Client.dragItemSlotSource) {
                                                    SpritePixels var27;
                                                    if (Client.isItemSelected == 1
                                                            && var19 == WorldMapIcon_0.selectedItemSlot
                                                            && var10.id == WorldMapLabel.selectedItemWidget) {
                                                        var27 = TextureProvider.getItemSprite(var26,
                                                                var10.itemQuantities[var19], 2, 0, 2, false);
                                                    } else {
                                                        var27 = TextureProvider.getItemSprite(var26,
                                                                var10.itemQuantities[var19], 1, 3153952, 2, false);
                                                    }

                                                    if (var27 != null) {
                                                        if (var10 == WorldMapLabelSize.dragInventoryWidget
                                                                && var19 == Client.dragItemSlotSource) {
                                                        ...
                                                        } else if (var10 == class378.field3629
                                                                && var19 == Client.field487) {
                                    ...
                                    if (var10.type == 4) {
                                        ...
                                        if (var42 == null) {
                                            ...
                                            if (UserComparator5.runCs1(var10)) {
                                                var20 = var10.color2;
                                                if (var10 == KeyHandler.mousedOverWidgetIf1
                                            ...
                                            if (var10.isIf3 && var10.itemId != -1) {
                                                ...
                                                if ((var51.isStackable == 1 || var10.itemQuantity != 1)
                                                        && var10.itemQuantity != -1) {
                                                    var50 = class149.colorStartTag(16748608) + var50 + "</col>" + " "
                                                            + 'x'
                                                            + WorldMapCacheName.formatItemStacks(var10.itemQuantity);
                                                }
                                            }
                                            ...
                                            var42.drawLines(var50, var12, var13, var10.width, var10.height, var20,
                                                    var10.textShadowed ? 0 : -1, var10.textXAlignment,
                                                    var10.textYAlignment, var10.textLineHeight);
                                        }
                                    } else if (var10.type == 5) {
                                        SpritePixels var44;
                                        if (!var10.isIf3) {
                                            var44 = var10.getSprite(UserComparator5.runCs1(var10),
                                                    class245.urlRequester);
                                            if (var44 != null) {
                                            ...
                                            if (var10.itemId != -1) {
                                                var44 = TextureProvider.getItemSprite(var10.itemId, var10.itemQuantity,
                                            ...
                                            if (var44 == null) {
                                                ...
                                                if (!var10.spriteTiling) {
                                                    ...
                                                    if (var10.spriteAngle != 0) {
                                                        var44.method2520(var10.width / 2 + var12,
                                                                var10.height / 2 + var13, var10.spriteAngle, var22);
                                                    } else if (var14 != 0) {
                                                        var44.drawTransScaledAt(var12, var13, var10.width, var10.height,
                                                                256 - (var14 & 255));
                                                    ...
                                                    for (var24 = 0; var24 < var22; ++var24) {
                                                        for (var25 = 0; var25 < var23; ++var25) {
                                                            if (var10.spriteAngle != 0) {
                                                                var44.method2520(var20 / 2 + var12 + var20 * var24,
                                                                        var21 / 2 + var13 + var21 * var25,
                                                                        var10.spriteAngle, 4096);
                                                            } else if (var14 != 0) {
                                                                var44.drawTransAt(var12 + var20 * var24,
                                                                        var13 + var25 * var21, 256 - (var14 & 255));
                                                            } else {
                                                                var44.drawTransBgAt(var12 + var20 * var24,
                                                                        var13 + var21 * var25);
                                                            }
                                                        }
                                                    }
                                        ...
                                        if (var10.type == 6) {
                                            ...
                                            if (var10.itemId != -1) {
                                                ...
                                                if (var10.modelId == 0) {
                                                    var46 = Client.playerAppearance.getModel((SequenceDefinition) null,
                                                ...
                                                var46 = var10.getModel(var36, var26, var39,
                                                        class387.localPlayer.appearance, var52, var47);
                                            ...
                                            if (var46 != null) {
                                                if (!var10.isIf3) {
                                                    var46.method1276(0, var10.modelAngleY, 0, var10.modelAngleX, 0,
                                                            var23, var24);
                                                } else {
                                                    var46.calculateBoundsCylinder();
                                                    if (var10.modelOrthog) {
                                                        var46.method1292(0, var10.modelAngleY, var10.modelAngleZ,
                                                                var10.modelAngleX, var10.modelOffsetX,
                                                                var22 + var23 + var10.modelOffsetY,
                                                                var24 + var10.modelOffsetY, var10.modelZoom);
                                                    } else {
                                                        var46.method1276(0, var10.modelAngleY, var10.modelAngleZ,
                                                                var10.modelAngleX, var10.modelOffsetX,
                                                                var22 + var23 + var10.modelOffsetY,
                                                ...
                                                for (var21 = 0; var21 < var10.rawHeight; ++var21) {
                                                    for (var22 = 0; var22 < var10.rawWidth; ++var22) {
                                                        if (var10.itemIds[var20] > 0) {
                                                            var34 = TileItem
                                                                    .ItemDefinition_get(var10.itemIds[var20] - 1);
                                                            String var31;
                                                            if (var34.isStackable != 1
                                                                    && var10.itemQuantities[var20] == 1) {
                                                                var31 = class149.colorStartTag(16748608) + var34.name
                                                                        + "</col>";
                                                            } else {
                                                                var31 = class149.colorStartTag(16748608) + var34.name
                                                                        + "</col>" + " " + 'x'
                                                                        + WorldMapCacheName.formatItemStacks(
                                                                                var10.itemQuantities[var20]);
                                                            }

                                                            var25 = var12 + var22 * (var10.paddingX + 115);
                                                            var26 = (var10.paddingY + 12) * var21 + var13;
                                                            if (var10.textXAlignment == 0) {
                                                                var42.draw(var31, var25, var26, var10.color,
                                                                        var10.textShadowed ? 0 : -1);
                                                            } else if (var10.textXAlignment == 1) {
                                                                var42.drawCentered(var31, var10.width / 2 + var25,
                                                                        var26, var10.color,
                                                                        var10.textShadowed ? 0 : -1);
                                                            } else {
                                                                var42.drawRightAligned(var31, var25 + var10.width - 1,
                                                                        var26, var10.color,
                                                                        var10.textShadowed ? 0 : -1);
                                                            }
                                                        }
                                            ...
                                            Font var32;
                                            if (var10.type == 8 && var10 == class18.field60
                                                    && Client.field534 == Client.field533) {
                                                var19 = 0;
                                                var20 = 0;
                                                ...
                                                String var49;
                                                for (var33 = FloorDecoration.method1141(var33, var10); var33
                                                        .length() > 0; var20 = var20 + var32.ascent + 1) {
                                                ...
                                                for (var33 = FloorDecoration.method1141(var33, var10); var33
                                                        .length() > 0; var26 = var26 + var32.ascent + 1) {
                                            ...
                                            if (var10.type == 9) {
                                                ...
                                                if (var10.lineWid == 1) {
                                                    ...
                                                    class17.method63(var19, var20, var21, var22, var10.color,
                                                            var10.lineWid);
                                                }
                                                ...
                                                if (var43 != null && var38 != null && var43.method1683()) {
                                                    var32 = var10.getFont();
                                                    if (var32 != null) {
                                                        Client.field583.method2537(var12, var13, var10.width,
                                                                var10.height, var43.method1684(), var43.method1704(), 0,
                                                                0, var43.method1716(), var43.method1682(),
                                                                var43.method1681());
                                                        var22 = var10.textShadowed
                                                                ? var10.spriteShadow * -151995323 * -513345907
                                                                : -1;
                                                        if (!var43.method1680() && var43.method1678().method1939()) {
                                                            Client.field583.method2535(var38.field2795, var22,
                                                                    var38.field2794, var38.field2797);
                                                            Client.field583.method2536(var43.method1714(), var32);
                                                        } else {
                                                            Client.field583.method2535(var10.color, var22,
                                                                    var38.field2794, var38.field2797);
