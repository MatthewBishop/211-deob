	...
	static int method44(int var0, Script var1, boolean var2) {
		...
		if (var0 == 4000) {
			...
			if (var0 == 4006) {
				...
				var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = (var3 & 1 << var4) != 0 ? 1
						: 0;
				return 1;
			} else if (var0 == 4011) {
				class302.Interpreter_intStackSize -= 2;
				...
				if (var3 == 0) {
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = (int) Math
				...
				var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
				var5 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 2];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class152.method815(var3,
						var4, var5);
				return 1;
			} else if (var0 == 4028) {
				class302.Interpreter_intStackSize -= 3;
				...
				var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
				var5 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 2];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = ArchiveDiskActionHandler
						.method1792(var3, var4, var5);
				return 1;
			} else if (var0 == 4029) {
				class302.Interpreter_intStackSize -= 3;
				var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
				...
				var5 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 2];
				var6 = 31 - var5;
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = var3 << var6 >>> var6
						+ var4;
				return 1;
			} else if (var0 == 4030) {
				...
				Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1] = NPC
						.method576(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4033) {
				Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1] = class388
						.method2046(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1]);
				return 1;
			} else if (var0 == 4034) {
				class302.Interpreter_intStackSize -= 2;
				var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
				...
				Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1] = Math
						.abs(Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize - 1]);
				return 1;
			} else {
				return 2;
			}
		...
		for (int var1 = 0; var1 < Client.npcCount; ++var1) {
			...
			if (var2 != null && var2.isVisible() && var2.definition.isVisible == var0
				...
				if (var3 >= 0 && var3 < 104 && var4 >= 0 && var4 < 104) {
					...
					long var5 = ItemLayer.calculateTag(0, 0, 1, !var2.definition.isInteractable,
							Client.npcIndices[var1]);
					var2.playerCycle = Client.cycle;
					WorldMapAreaData.scene.drawEntity(class103.Client_plane, var2.x, var2.y,
							GrandExchangeOfferNameComparator.getTileHeight(var2.field939 * 64 - 64 + var2.x,
									var2.field939 * 64 - 64 + var2.y, class103.Client_plane),
							var2.field939 * 64 - 64 + 60, var2, var2.rotation, var5, var2.isWalking);
				}
			}
		}
