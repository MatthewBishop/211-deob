public class Skills {
	...
	static final void addPendingSpawnToScene(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (0L != var7) {
				...
				if (var1 == 2) {
					...
					if (var2 + var13.sizeX > 103 || var3 + var13.sizeX > 103 || var2 + var13.sizeY > 103
							|| var3 + var13.sizeY > 103) {
						return;
					}

					if (var13.interactType != 0) {
						Client.collisionMaps[var0].setFlagOffNonSquare(var2, var3, var13.sizeX, var13.sizeY, var16,
								var13.boolean1);
					}
				}
			...
			if (var4 >= 0) {
				...
				class155.method829(var0, var12, var2, var3, var4, var5, var6, WorldMapAreaData.scene,
	...
	static void method1779(int var0, int var1) {
		...
		if (var2 != null) {
			FileSystem.menuAction(var2.param0, var2.param1, var2.opcode, var2.identifier, var2.itemId, var2.action,
