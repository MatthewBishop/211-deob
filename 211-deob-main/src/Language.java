...
public class Language implements class349 {
	...
	static {
		...
		Language[] var0 = new Language[] { Language_ES, field3527, Language_EN, field3524, Language_FR, field3533,
				field3528 };
	...
	static boolean method1880() {
		...
		try {
			...
			HealthBarUpdate.method507("Date not valid.", "Please ensure date follows the format",
			...
			try {
				...
				while (true) {
					...
					if (var6 == 4) {
						...
						var11 = var2[var4++];
						if (var11 != -1
								&& (!TileItem.ItemDefinition_get(var11).isMembersOnly || Client.isMembersWorld)) {
