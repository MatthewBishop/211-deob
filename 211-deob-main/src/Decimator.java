public class Decimator {
		...
		if (var0 != null && var0.isVisible() && !var0.isHidden) {
			...
			if (var2 >= 0 && var2 < 104 && var3 >= 0 && var3 < 104) {
				...
				if (var0.attachedModel != null && Client.cycle >= var0.animationCycleStart
					...
					var0.isUnanimated = false;
					var0.tileHeight = GrandExchangeOfferNameComparator.getTileHeight(var0.x, var0.y,
							class103.Client_plane);
					var0.playerCycle = Client.cycle;
					WorldMapAreaData.scene.addNullableObject(class103.Client_plane, var0.x, var0.y, var0.tileHeight, 60,
							var0, var0.rotation, var4, var0.minX, var0.minY, var0.maxX, var0.maxY);
				} else {
					...
					var0.tileHeight = GrandExchangeOfferNameComparator.getTileHeight(var0.x, var0.y,
							class103.Client_plane);
					var0.playerCycle = Client.cycle;
					WorldMapAreaData.scene.drawEntity(class103.Client_plane, var0.x, var0.y, var0.tileHeight, 60, var0,
	...
	static final void processZoneOperation(ZoneOperation var0) {
		...
		if (ZoneOperation.field2546 == var0) {
			...
			if (var8 >= 0 && var9 >= 0 && var8 < 103 && var9 < 103) {
				if (var6 == 0) {
					...
					if (var10 != null) {
						...
						if (var4 == 2) {
							var10.renderable1 = new DynamicObject(var11, 2, var5 + 4, class103.Client_plane, var8, var9,
									var2, false, var10.renderable1);
							var10.renderable2 = new DynamicObject(var11, 2, var5 + 1 & 3, class103.Client_plane, var8,
									var9, var2, false, var10.renderable2);
						} else {
							var10.renderable1 = new DynamicObject(var11, var4, var5, class103.Client_plane, var8, var9,
									var2, false, var10.renderable1);
						}
					}
				}
				...
				if (var6 == 1) {
					...
					if (var39 != null) {
						...
						if (var4 != 4 && var4 != 5) {
							if (var4 == 6) {
								var39.renderable1 = new DynamicObject(var11, 4, var5 + 4, class103.Client_plane, var8,
										var9, var2, false, var39.renderable1);
							} else if (var4 == 7) {
								var39.renderable1 = new DynamicObject(var11, 4, (var5 + 2 & 3) + 4,
										class103.Client_plane, var8, var9, var2, false, var39.renderable1);
							} else if (var4 == 8) {
								var39.renderable1 = new DynamicObject(var11, 4, var5 + 4, class103.Client_plane, var8,
										var9, var2, false, var39.renderable1);
								var39.renderable2 = new DynamicObject(var11, 4, (var5 + 2 & 3) + 4,
										class103.Client_plane, var8, var9, var2, false, var39.renderable2);
							}
						} else {
							var39.renderable1 = new DynamicObject(var11, 4, var5, class103.Client_plane, var8, var9,
									var2, false, var39.renderable1);
						}
					}
				}
				...
				if (var6 == 2) {
					...
					if (var40 != null) {
						var40.renderable = new DynamicObject(class124.Entity_unpackID(var40.tag), var4, var5,
								class103.Client_plane, var8, var9, var2, false, var40.renderable);
					}
				}

				if (var6 == 3) {
					FloorDecoration var41 = WorldMapAreaData.scene.getFloorDecoration(class103.Client_plane, var8,
							var9);
					if (var41 != null) {
						var41.renderable = new DynamicObject(class124.Entity_unpackID(var41.tag), 22, var5,
								class103.Client_plane, var8, var9, var2, false, var41.renderable);
					}
				}
			}
			...
			TileItem var45;
			if (ZoneOperation.field2549 == var0) {//OBJ_ADD
				var2 = var1.readUnsignedByte();//offset hash
				var3 = (var2 >> 4 & 7) + class373.field3599;
				var4 = (var2 & 7) + KeyHandler.field86;
				var5 = var1.method2401();//op flags
				var1.method2401();//skipped
				var1.readUnsignedShortLEA();//skipped
				var6 = var1.readUnsignedByteS();//id
				var7 = var1.readInt();//amount
				var1.method2401();//skipped
				var1.readUnsignedByteS();//skipped
				...
				if (ZoneOperation.field2550 == var0) {
					...
					if (var8 >= 0 && var9 >= 0 && var8 < 104 && var9 < 104) {
						var32 = var4 + 1;
						if (class387.localPlayer.pathX[0] >= var8 - var32
								&& class387.localPlayer.pathX[0] <= var32 + var8
								&& class387.localPlayer.pathY[0] >= var9 - var32
								&& class387.localPlayer.pathY[0] <= var32 + var9
								&& PacketWriter.clientPreferences.getAreaSoundEffectsVolume() != 0 && var5 > 0
				...
				NodeDeque var33;
				if (ZoneOperation.field2542 == var0) {// OBJ_DEL
					...
					if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
						ObjTypeCustomisation.updatePendingSpawn(class103.Client_plane, var3, var4, var8, -1, var6, var7,
								31, 0, -1);
					}
					...
					if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
						ObjTypeCustomisation.updatePendingSpawn(class103.Client_plane, var5, var6, var32, var3, var8,
								var9, var2, 0, -1);
					}
					...
					NodeDeque var31;
					TileItem var34;
					if (ZoneOperation.field2543 == var0) {//OBJ_COUNT
						var2 = var1.readUnsignedShortLEA();
						...
						if (var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) {
							...
							if (var31 != null) {
								for (var34 = (TileItem) var31.last(); var34 != null; var34 = (TileItem) var31
										.previous()) {
						...
						if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
							var33 = Client.groundItems[class103.Client_plane][var3][var4];
							if (var33 != null) {
								for (var45 = (TileItem) var33.last(); var45 != null; var45 = (TileItem) var33
										.previous()) {
						...
						if (ZoneOperation.field2540 == var0) {
							...
							if (var17 != null) {
								...
								int var26 = var25[var21][var23] + var25[var22][var23] + var25[var21][var24]
										+ var25[var22][var24] >> 2;
								int var27 = (var13 << 7) + (var19 << 6);
								int var28 = (var14 << 7) + (var20 << 6);
								Model var29 = var18.getModel(var7, var8, var25, var27, var26, var28);
								if (var29 != null) {
									ObjTypeCustomisation.updatePendingSpawn(class103.Client_plane, var13, var14, var9,
											-1, 0, 0, 31, var5 + 1, var11 + 1);
						...
						if (ZoneOperation.field2545 != var0) {
							...
							if (ZoneOperation.field2541 == var0) {
								...
								var11 = var42 + var13;
								var32 = var46 + var14;
								if (var13 >= 0 && var14 >= 0 && var13 < 104 && var14 < 104 && var11 >= 0 && var32 >= 0
										&& var11 < 104 && var32 < 104 && var2 != 65535) {
									var13 = var13 * 128 + 64;
									var14 = var14 * 128 + 64;
									var11 = var11 * 128 + 64;
									var32 = var32 * 128 + 64;
									var35 = new Projectile(var2, class103.Client_plane, var13, var14,
											GrandExchangeOfferNameComparator.getTileHeight(var13, var14,
													class103.Client_plane) - var7,
											var8 + Client.cycle, var9 + Client.cycle, var3, var5, var4, var6);
									var35.setDestination(var11, var32, GrandExchangeOfferNameComparator
											.getTileHeight(var11, var32, class103.Client_plane) - var6,
											var8 + Client.cycle);
								...
								var14 = var43 + var4;
								var8 = var38 + var5;
								if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104 && var14 >= 0 && var8 >= 0
										&& var14 < 104 && var8 < 104 && var6 != 65535) {
									var4 = var4 * 128 + 64;
									var5 = var5 * 128 + 64;
									var14 = var14 * 128 + 64;
									var8 = var8 * 128 + 64;
									var35 = new Projectile(var6, class103.Client_plane, var4, var5,
											GrandExchangeOfferNameComparator.getTileHeight(var4, var5,
													class103.Client_plane) - var12,
											var9 + Client.cycle, var13 + Client.cycle, var2, var7, var11, var32);
									var35.setDestination(var14, var8, GrandExchangeOfferNameComparator
											.getTileHeight(var14, var8, class103.Client_plane) - var32,
											var9 + Client.cycle);
									Client.projectiles.addFirst(var35);
								}
								...
								if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
									var3 = var3 * 128 + 64;
									var4 = var4 * 128 + 64;
									GraphicsObject var44 = new GraphicsObject(
											var7, class103.Client_plane, var3, var4, GrandExchangeOfferNameComparator
													.getTileHeight(var3, var4, class103.Client_plane) - var6,
											var5, Client.cycle);
