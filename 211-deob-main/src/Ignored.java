...
public class Ignored extends User {
	...
	static final int method2123(long var0, String var2) {
		...
		for (int var15 = 0; var15 < var13 + 0; var15 += 3) {
			...
			if (var15 < var13 - 1) {
				...
				if (var15 < var13 - 2) {
					...
					var14.append(class363.field3571[(var17 & 15) << 2 | var18 >>> 6])
							.append(class363.field3571[var18 & 63]);
				} else {
		...
		try {
			...
			var20.write(
					"data2=" + GameObject.method1310(var12) + "&dest=" + GameObject.method1310("passwordchoice.ws"));
			var20.flush();
