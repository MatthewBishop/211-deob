public final class class361 {
	...
	static final void method1923() {
		...
		for (var1 = 0; var1 < class4.regionLandArchives.length; ++var1) {
			...
			if (class217.regionLandArchiveIds[var1] != -1 && class323.regionMapArchives[var1] == null) {
				class323.regionMapArchives[var1] = NetCache.archive9
						.takeFileEncrypted(class217.regionLandArchiveIds[var1], 0, GrandExchangeOffer.xteaKeys[var1]);
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var15 = 0; var15 < var1; ++var15) {
						...
						if (var5 != null) {
							HorizontalAlignment.playPcmPlayers();
							class121.method673(var5, var3, var4, class303.timeOfPreviousKeyPress * 8 - 48,
									ScriptFrame.field343 * 8 - 48, Client.collisionMaps);
						}
					}
							...
							for (var4 = 0; var4 < 13; ++var4) {
								...
								if (var6 != -1) {
									...
									for (int var12 = 0; var12 < MusicPatch.regions.length; ++var12) {
										if (MusicPatch.regions[var12] == var11
												&& class4.regionLandArchives[var12] != null) {
											int var13 = (var9 - var3) * 8;
											int var14 = (var10 - var4) * 8;
											class142.method760(class4.regionLandArchives[var12], var15, var3 * 8,
							...
							for (var4 = 0; var4 < 13; ++var4) {
								...
								if (var17 != -1) {
									...
									for (var11 = 0; var11 < MusicPatch.regions.length; ++var11) {
										if (MusicPatch.regions[var11] == var10
												&& class323.regionMapArchives[var11] != null) {
											Tiles.method447(class323.regionMapArchives[var11], var15, var3 * 8,
													var4 * 8, var6, (var8 & 7) * 8, (var9 & 7) * 8, var7,
													WorldMapAreaData.scene, Client.collisionMaps);
											break;
										}
									}
								}
	...
	static final void worldToMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
		...
		if (var6 > 4225 && var6 < 90000) {
			...
			byte var17 = 20;
			PacketBufferNode.redHintArrowSprite.method2517(var15 + (var0 + var5.width / 2 - var17 / 2),
