				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					if (class36.clientLanguage == Language.Language_EN) {
						if (MouseHandler.MouseHandler_lastButton == 1
							...
							byte var7 = 100;
							byte var8 = 35;
							if (MouseHandler.MouseHandler_lastPressedX >= var21
									&& MouseHandler.MouseHandler_lastPressedX <= var7 + var21
									&& MouseHandler.MouseHandler_lastPressedY >= var6
									&& MouseHandler.MouseHandler_lastPressedY <= var8 + var6) {
					...
					if (Login.loginIndex == 0) {
						...
						var35 = 291;
						if (var21 == 1 && var31 >= var34 - 75 && var31 <= var34 + 75 && var32 >= var35 - 20
								&& var32 <= var35 + 20) {
							AttackOption.openURL(class310.method1760("secure", true)
									+ "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}

						var34 = class143.loginBoxCenter + 80;
						if (var21 == 1 && var31 >= var34 - 75 && var31 <= var34 + 75 && var32 >= var35 - 20
								&& var32 <= var35 + 20 || var42) {
						...
						if (Login.loginIndex == 1) {
							while (true) {
								if (!var9.method1085()) {
									...
									var11 = 321;
									if (var21 == 1 && var31 >= var10 - 75 && var31 <= var10 + 75 && var32 >= var11 - 20
											&& var32 <= var11 + 20) {
										UserComparator6.Login_promptCredentials(false);
									}
							...
							if (Login.loginIndex == 2) {
								...
								if (Calendar.field3019 != null) {
									...
									if (var21 == 1 && var31 >= Calendar.field3019.lowX - var34
											&& var31 <= var34 + Calendar.field3019.lowX && var32 >= var33 - 15
											&& var32 < var33) {
										switch (Login.field752) {
										case 1:
											class70.setLoginResponseString("Please enter your username.",
								...
								var35 = 277;
								Login.field772 = var31 >= var34 && var31 < var34 + WorldMapRectangle.field2360
										&& var32 >= var35 && var32 < var35 + class134.field1277;
								if (var21 == 1 && Login.field772) {
									Client.Login_isUsernameRemembered = !Client.Login_isUsernameRemembered;
									if (!Client.Login_isUsernameRemembered
											&& clientPreferences.getUsernameToRemember() != null) {
								...
								var35 = 277;
								Login.field768 = var31 >= var34 && var31 < var34 + WorldMapRectangle.field2360
										&& var32 >= var35 && var32 < var35 + class134.field1277;
										...
										while (true) {
													...
													while (var9.method1085()) {
														if (var9.field1832 != 13) {
															...
															for (var14 = 0; var14 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																	.length()
																	&& var37 != "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																			.charAt(var14); ++var14) {
																;
															}
															...
															boolean var40 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																	.indexOf(var39) != -1;
											...
											if (var9.field1832 == 85 && Login.Login_password.length() > 0) {
												...
												if (var9.field1832 == 84) {
													Login.Login_username = Login.Login_username.trim();
													if (Login.Login_username.length() == 0) {
														class70.setLoginResponseString("",
											...
											if ((var9.getKeyPressed(82) || var9.getKeyPressed(87))
													&& var9.field1832 == 67) {
											...
											if (MusicPatch.method1608(var9.field1826)) {
												...
												var36 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
														.indexOf(var41) != -1;
								...
								if (Login.loginIndex == 4) {
									...
									if (var21 == 1 && var31 >= Login.loginBoxX + 180 - 9
											&& var31 <= Login.loginBoxX + 180 + 130 && var32 >= 263 && var32 <= 296) {
										Login.field764 = !Login.field764;
									}

									if (var21 == 1 && var31 >= Login.loginBoxX + 180 - 34
											&& var31 <= Login.loginBoxX + 34 + 180 && var32 >= 351 && var32 <= 363) {
										AttackOption.openURL(class310.method1760("secure", true)
									...
									while (var9.method1085()) {
										...
										if (var9.field1832 == 13) {
											...
											if (var9.field1832 == 85 && InvDefinition.otp.length() > 0) {
												InvDefinition.otp = InvDefinition.otp.substring(0,
														InvDefinition.otp.length() - 1);
											}
									...
									if (class290.field2708 != null) {
										...
										if (var21 == 1 && var31 >= class290.field2708.lowX - var13
												&& var31 <= var13 + class290.field2708.lowX && var32 >= var35 - 15
												&& var32 < var35) {
											AttackOption.openURL(class310.method1760("secure", true)
									...
									while (var9.method1085()) {
										...
										for (var14 = 0; var14 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
												.length(); ++var14) {
											if (var9.field1826 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
													.charAt(var14)) {
												var36 = true;
												break;
											}
									...
									if (Login.loginIndex == 7) {
										if (class209.field1857 && !Client.onMobile) {
											...
											var35 = 231;
											var13 = var35 + 40;
											if (var21 == 1 && var31 >= var10 && var31 <= var34 && var32 >= var35
													&& var32 <= var13) {
												var15 = var10;
												int var25 = 0;
											...
											short var38 = 321;
											boolean var45;
											if (var21 == 1 && var31 >= var14 - 75 && var31 <= var14 + 75
													&& var32 >= var38 - 20 && var32 <= var38 + 20) {
											...
											var10 = Login.loginBoxX + 180 - 80;
											var11 = 321;
											if (var21 == 1 && var31 >= var10 - 75 && var31 <= var10 + 75
													&& var32 >= var11 - 20 && var32 <= var11 + 20) {
												AttackOption.openURL(
														class310.method1760("secure", true) + "m=dob/set_dob.ws", true,
														false);
												class70.setLoginResponseString("", "Page has opened in a new window.",
										...
										var10 = Login.loginBoxX + 180;
										var11 = 311;
										if (var22.field1832 == 84 || var22.field1832 == 13
												|| var21 == 1 && var31 >= var10 - 75 && var31 <= var10 + 75
														&& var32 >= var11 - 20 && var32 <= var11 + 20) {
											GrandExchangeOfferNameComparator.method1845(false);
										}
										...
										var10 = Login.loginBoxX + 180;
										var11 = 209;
										if (var22.field1832 == 84 || var21 == 1 && var31 >= var10 - 109
												&& var31 <= var10 + 109 && var32 >= var11 && var32 <= var11 + 68) {
											class70.setLoginResponseString("", "Connecting to server...", "");
										...
										var11 = 233;
										Bounds var26 = var1.method1999(0, 30,
												"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
												var10, var11);
										Bounds var23 = var1.method1999(32, 32,
												"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
												var10, var11);
										Bounds var24 = var1.method1999(70, 34,
												"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
												var10, var11);
										var34 = var11 + 17;
										Bounds var27 = var1.method1999(0, 34, "<col=ffd200>agreement (EULA)</col>.",
												var10, var34);
										if (var21 == 1) {
											if (var26.method2160(var31, var32)) {
												...
												AttackOption.openURL("https://www.jagex.com/terms/privacy", true,
														false);
											} else if (var24.method2160(var31, var32)
													|| var27.method2160(var31, var32)) {
												AttackOption.openURL(
										...
										var35 = 276;
										if (var21 == 1 && var31 >= var34 - 75 && var31 <= var34 + 75
												&& var32 >= var35 - 20 && var32 <= var35 + 20) {
	...
	static int method626(int var0, Script var1, boolean var2) {
		if (var0 == 3300) {
			...
			if (var0 == 3301) {
				...
				var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = DefaultsGroup
				...
				var3 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize];
				var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = ZoneOperation
						.method1535(var3, var4);
				return 1;
			} else if (var0 == 3304) {
				var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
				Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = WorldMapArea
				...
				if (var0 == 3308) {
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = (var4 << 14) + var5
							+ (var3 << 28);
					return 1;
				} else if (var0 == 3309) {
					var3 = Interpreter.Interpreter_intStack[--class302.Interpreter_intStackSize];
					...
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = Client.isMembersWorld
							? 1
							: 0;
					return 1;
				} else if (var0 == 3313) {
					...
					var4 = Interpreter.Interpreter_intStack[class302.Interpreter_intStackSize + 1];
					Interpreter.Interpreter_intStack[++class302.Interpreter_intStackSize - 1] = class6.method17(var3,
							var4);
					return 1;
				} else if (var0 == 3314) {
					class302.Interpreter_intStackSize -= 2;
