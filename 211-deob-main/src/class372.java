...
public class class372 {
				...
				if (!this.field3590.isEmpty()) {
					for (int var3 = 0; var3 < this.field3590.size(); ++var3) {
						...
						if (var2 <= var4.field3602 + this.method1953()) {
							...
							if (var3 + 1 != this.field3590.size()
									&& ((class374) this.field3590.get(var3 + 1)).field3602 != var4.field3602) {
					...
					if (var1 >= var6.field3601 && var1 <= var6.field3601 + this.method1955() && var2 >= var6.field3602
							&& var2 <= var6.field3602 + this.method1953()) {
	...
	public int method1969() {
		if (!this.field3590.isEmpty() && this.method1964() == 1) {
			return this.field3590.isEmpty() ? 0
					: ((class374) this.field3590.get(this.field3590.size() - 1)).field3601 + this.method1955();
		} else {
			int var1 = -1;
			int var2 = 0;
	...
	public int method1952() {
		return this.method1939() ? 0
				: this.field3594.ascent + ((class374) this.field3590.get(this.field3590.size() - 1)).field3602;
	}
	...
	class374 method1960(int var1) {
		if (var1 > 0 && !this.field3590.isEmpty()) {
			return var1 >= this.field3590.size() ? (class374) this.field3590.get(this.field3590.size() - 1)
					: (class374) this.field3590.get(var1 - 1);
		} else {
			return new class374();
		}
	}
	...
	int method1949(int var1) {
		if (var1 > 0 && !this.field3590.isEmpty()) {
			return var1 >= this.field3590.size() ? this.method1961(this.field3590.size() - 1)
					: this.method1961(var1 - 1);
		} else {
			return 0;
		}
	}
