public class HitSplatDefinition extends DualNode {
	...
	static final void method1013(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 8) != 0) {
			...
			PlayerType var17 = (PlayerType) class4.findEnumerated(ArchiveLoader.PlayerType_values(),
					var0.readUnsignedShortA());
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var10 && Client.field494 == 0 && !var2.isHidden) {
					...
					Players.field1091.offset = 0;
					String var11 = AbstractFont
							.escapeBrackets(ParamComposition.method994(class163.readString(Players.field1091)));
					var2.overheadText = var11.trim();
					var2.field937 = var5 >> 8;
					var2.field961 = var5 & 255;
					var2.overheadTextCyclesRemaining = 150;
					var2.isAutoChatting = var13;
					var2.showPublicPlayerChat = var2 != class387.localPlayer && var17.isUser && "" != Client.field604
							&& var11.toLowerCase().indexOf(Client.field604) == -1;
					...
					if (var17.modIcon != -1) {
						ZoneOperation.addGameMessage(var12,
								ObjectSound.addImageTag(var17.modIcon) + var2.username.getName(), var11);
					} else {
		...
		if ((var3 & 16384) != 0) {
			...
			MoveSpeed[] var19 = new MoveSpeed[] { MoveSpeed.WALK, MoveSpeed.STATIONARY, MoveSpeed.RUN,
					MoveSpeed.CRAWL };
		...
		if (var2.hasMovementPending) {
			if (var4 == 127) {
				...
				if (var4 != MoveSpeed.STATIONARY.speed) {
					MoveSpeed[] var18 = new MoveSpeed[] { MoveSpeed.WALK, MoveSpeed.STATIONARY, MoveSpeed.RUN,
							MoveSpeed.CRAWL };
